...
$searchquery = "SELECT R.*,V.* FROM photo_request V,register R WHERE V.sender  = '".$_SESSION['matriid']."' $keystatus AND V.receiver = R.MatriID and V.type = 'photo_request'"; 
...
<span class="pathway"> <?Php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Photo Request Sent</span>
</div>
        </li>
