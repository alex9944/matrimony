...
$searchquery = "SELECT R.*, pd.matriid, pd.spot_light FROM register R LEFT JOIN payment_details pd ON pd.matriid = R.MatriID, addtofavorite A WHERE Status <> 'InActive' AND Status <> '' AND A.memberid='".$_SESSION['matriid']."' AND A.favmemberid = R.MatriID ";
...
<!-- <div id="breadcrumb"> 
    <ul class="breadcrumbs">
      <li class="left"></li>
      <li class="center">
        <div id="breadcrumb_text">You are Here: <span class="pathway"> <?php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">My Favourites</span> </div>
      </li>
      <li class="right"></li>
    </ul>
    </div> -->
...
<form action="" method="post" name="searchrsforms" id="searchrsforms" class="col-md-9">
    <div id="inner_right" class="col-md-8" style="width:100%!important">
 <!-- BUSINESS PAGE CONTENT STARTS HERE ############################################ -->   
    <a name="top" id="top"></a>
 
      <h2 style="color: #C8060E!important">My Favourites</h2>
...
<?Php if(isset($_SESSION['username'])) { ?>
  <div style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #f9d6a5;" class="footer"> 
		   ...
		   <a class="btn_services btn_block float_right" href="blockmember.php?id=<?php echo $searchresultfetch['MatriID']; ?>&key=unblock">Block this Member</a>
		   
		   <a style="border-left-width: 1px; border-left-style: solid; border-left-color: #f9d6a5;" class="btn_services btn_favorite float_right" href="my_favourites.php?id=<?php echo $searchresultfetch['MatriID']; ?>&key=unfavorite">Make Unfavorite</a>
