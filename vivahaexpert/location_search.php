...
<script language="javascript" src="js/locationsearch.js"></script>
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <h2 class="float_left title">
          ...
          <span style="color:#333;" class="black">Matrimonial - </span>Location Search
        ...
        <div class="body">
          ...
          <table cellspacing="5" cellpadding="5" border="0" width="100%">
	        ...
	        <tbody><tr>
    	        ...
    	        <td width="80" height="80"><img align="left" width="64" vspace="10" hspace="10" height="64" src="images/icons/search/search_globe.png"></td>

                <td>Search based on a Location criteria one would look for in a partner.</td>

            </tr></tbody>

          </table>

          <form action="locsearch_results.php" method="get" name="MatriForm" id="MatriForm">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="2" class="tbl_profiledetails">
              ...
              <tr class="hline2">
                ...
                <td><div align="left">
                    ...
                    <input name="location" type="text" id="location" class="textbox1" style="width:214px;">

                    (Ex: Chennai, Pondicherry ..etc)</div></td>
              </tr>
