...
$searchquery = "SELECT R.*,V.* FROM phone_request V,register R WHERE V.receiver  = '".$_SESSION['matriid']."' $keystatus AND V.sender = R.MatriID and V.type = 'phone_password'"; 
...
?>
			...
			$statussql    = "select * from phone_request_status where receiver_id  = '$recid' and sender_id  = '$sender_id ' ";
			...
			{ ?>
			 <a style="border-left-width: 1px; border-left-style: solid; border-left-color: #f9d6a5;" class="btn_services btn_block float_right" href="#" onClick="MM_openBrWindow('phonesend.php?ReqID=<?php echo $reqid; ?>&MatriID=<?php echo $recid; ?>&key=declined','ppreq','width=650,height=550')">Phone Request Declined</a>
			  <a style="border-left-width: 1px; border-left-style: solid; border-left-color: #f9d6a5;" class="btn_services btn_varify float_right" href="#" onClick="MM_openBrWindow('phonesend.php?ReqID=<?php echo $reqid; ?>&MatriID=<?php echo $recid; ?>&key=accept','ppreq','width=650,height=550')">Phone Request Accept</a> <?php
			  $photo_status  = "<b style='color:red;'>$photostatus</b>";
			} 
		   else if($photostatus == 'accept')
		    { ?> 
			 <a style="border-left-width: 1px; border-left-style: solid; border-left-color: #f9d6a5;" class="btn_services btn_block float_right" href="#" onClick="MM_openBrWindow('phonesend.php?ReqID=<?php echo $reqid; ?>&MatriID=<?php echo $recid; ?>&key=declined','ppreq','width=650,height=550')">Phone Request Declined</a> <?php
