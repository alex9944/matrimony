...
$update1 = mysql_query("UPDATE expressinterest SET eisender_accept = 'Accept', eirec_accept ='Accept', updated_date = '$updated_date' WHERE id = '$streimid' ")
...
<tr>
  ...
  <td valign=top class=style3>Congratulations! Your profile has been viewed and Accepted your expressed interest on $sitename</td>

</tr>

<tr>

<td valign=top class=style3>Hi I am $strloggedid, I did see your profile on $sitename and i accepted your expresses interest message.<br>

<span class=style3>

Kindly logon to $sitename and contact $strloggedid and proceed furthur. 
...
<td><img src=pics/email_bottom.gif width=600 height=18></td>
	...
	$headers .= 'From: '.ucfirst($sitename).' <'.$siteadmin.'>'."\r\n";
		...
		$sms_message  = "Hi ".$nick_name.", ".$sender." has accepted your interest. Visit ".$site_url."  to take next step...";
  ...
  <div id="content_area">
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        <div class="header">
          <h3 class="float_left title">Accept Express Pending</h3>
        </div>
    ...
    <tr>
      ...
      <td><div align="center"><strong>Your Accept Message has been sent to the Member Successful.</strong></div>
        </td>
