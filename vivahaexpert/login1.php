    ...
    <div id="inner_right">
      ...
      <div class="profile_block ">
        ...
        <div class="header">
          ...
          <span class="black" style="color:#C8060E;">Member Login</span></h2>
...
<tr height="10"></tr>
              ...
              <tr height="7">
                ...
                <td style="padding-top:5px;">                  <!--<input name="Submit" type="submit" value="Submit" src="pics/lgn-button.gif" />-->

				<input class="button-small square-orange uppercase" style="clear:both; border:0px; text-align:center; width:65px;" name="Submit" type="image" value="Submit">
        ...
        <td width="45%" valign="top" ><br />
            ...
            <table cellspacing="2" cellpadding="2">
              ...
              <tr valign="center" align="middle">
                ...
                <td colspan="2" height="50"><div align="center"><a href="registration1.php" class="btn_registerfree"><img src="images/btn_registerfree.gif" width="136" height="46" alt="register free" /></a></div></td>
