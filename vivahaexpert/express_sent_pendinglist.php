...
$sql = mysql_query("Select * from expressinterest where eirec_accept='Pending' and eisender='$strid' order by id desc LIMIT $from, $max_results ");
?>
<div id="wrapper"> 
    ...
    <tr>
      ...
      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td>Listed Below are <strong>PENDING</strong> your sent expressed interest.</td>
...
$total_results =  mysql_result(mysql_query("SELECT COUNT(*) as Num FROM expressinterest where eirec_accept='Pending' and eisender='$strid' "),0); 
