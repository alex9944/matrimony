...
while($row = mysql_fetch_array($result))

  {
	...
	if($status == 'accept')
	 {
	    $photostatus  =  "<p>Heres your Request Photo Password<br> MatriID :".$strsenderid."<br> Photo Password : ".$strsenderppp." </p>";
	 }
	else
	 {
	    $photostatus  =  "<p>Heres your Request Photo Password has been declined.</p>";
	 } 
	
	$subject = "Your request Photo Password status : ".$sitename."";
	...
	$headers .= 'From: '.ucfirst($sitename).' <'.$siteadmin.'>'."\r\n";
			...
			$db_message = "<p>Thank you for requesting member\'s Photo Password.</p>
			<p>".$sitename.", the Most Successful Matrimony Portal for Indians.</p>
			".$photostatus." ";
...
$sql  = "update photo_request_status set status = '$status', updated_date = '$ctime' where sender_id = '$strtoid' and receiver_id = '$strsenderid' and type = 'photo_password'";
$sql  = mysql_query($sql);

$sql  = "update photo_request set status = '$status', updated_date = '$ctime' where sender  = '$strtoid' and receiver  = '$strsenderid' and type = 'photo_password' $cond ";
$sql  = mysql_query($sql);
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <td><div align="center">Your Photo Password Status has been sent to this Member <?php echo $strtoid; ?> successfully. </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
