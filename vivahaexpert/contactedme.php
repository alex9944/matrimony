...
//END PAGING
  ...
  $searchquery = "SELECT R.*,V.*,  pd.matriid, pd.spot_light FROM sendmessage V,register R LEFT JOIN payment_details pd ON pd.matriid = R.MatriID WHERE V.receiver  = '".$_SESSION['matriid']."' AND V.sender = R.MatriID"; 
