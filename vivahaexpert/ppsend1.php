...
while($row = mysql_fetch_array($result))

  {
	...
	if($status == 'accept')
	 {
	    $photostatus  =  "<p>Heres your photo request has been approved</p>";
	 }
	else
	 {
	    $photostatus  =  "<p>Heres your photo request has been declined.</p>";
	 } 
	
	$subject = "Your Photo request status : $status on $sitename";
	...
	$headers .= 'From: '.ucfirst($sitename).' <'.$siteadmin.'>'."\r\n";
			...
			$db_message = "<p>Thank you for requesting member\'s Photo upload.</p>
			<p>$sitename, the Most Successful Matrimony Portal for Indians.</p>
			$photostatus ";
...
$sql  = "update photo_request_status set status = '$status', updated_date = '$ctime' where sender_id = '$strtoid' and receiver_id = '$strsenderid' and type = 'photo_request'";
$sql  = mysql_query($sql);

$sql  = "update photo_request set status = '$status', updated_date = '$ctime' where sender  = '$strtoid' and receiver  = '$strsenderid' and type = 'photo_request'";
$sql  = mysql_query($sql);
...
<div class="profile_block">
  <div class="header">
    <h3 class="float_left title">Photo Request</h3>
  </div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <td><div align="center">Your Photo Status has been sent to this Member <?php echo $strtoid; ?> successfully. </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
