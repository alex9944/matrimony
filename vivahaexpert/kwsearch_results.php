...
if($search != "")
{
$searchquery .=  " AND MATCH (Education,Educationdetails,Occupation,Employedin,Religion,Caste,Subcaste,Language,Country,State,City,Residencystatus,Profile) AGAINST('%$search*' IN  BOOLEAN MODE) ";
	$searchcondition .= ", Keyword:".$search;
}
...
if($StrCaste != "Any" && $StrCaste != ""  )
{
	...
	$searchcondition .= ", Caste:".$StrCaste;
}
if($StrPhoto != "")
  ...
  <div id="content_area">
    ...
    <form action="" method="post" name="searchrsforms" id="searchrsforms">
      <div id="inner_right">
        ...
        <br />
        <strong> You have searched for:</strong> <?php echo $StrGender; ?>, <?php echo $StrSAge; ?> yrs to <?php echo $StrEAge; ?> yrs <?php echo $searchcondition;?>. <br />
...
//$link = "&gender=".$_REQUEST["gender"]."&age1=".$_REQUEST["age1"]."&age2=".$_REQUEST["age2"]."&txtkey=".$_REQUEST["txtkey"]."&religion=".$_REQUEST['religion']."&caste=".$_REQUEST['caste']."&photo=".$_REQUEST["photo"];
$link = "&gender=".$_REQUEST["gender"]."&age1=".$_REQUEST["age1"]."&age2=".$_REQUEST["age2"]."&txtkey=".$_REQUEST["txtkey"]."&photo=".$_REQUEST["photo"];
?>
...
?>
        ...
        <?php  $strheight  =  $searchresultfetch['Height'];
...
?>
	    ...
	    <div class="profile_block <?php if($pre_count > 0) echo 'profile_block_featured'; ?>">
          <div class="header"><a href="viewfullprofile1.php?id=<?php echo $searchresultfetch['MatriID']; ?>" class="title" target="_blank"><?php echo $searchresultfetch["Name"];?> (<?php echo $searchresultfetch["MatriID"];?>)</a> <a href="#" class="icon_acc_type acc_golden" title="<?php echo $sitename; ?> Golden Account Holder"></a>
            <!--<span class="icon status stat_online">Active: <strong>Online Now</strong></span> -->
            <a href="viewfullprofile1.php?page=<?php echo $searchresultfetch['MatriID']; ?>" class="icon_acc_type" title="<?php echo $sitename; ?> <?php echo $plan; ?> Account Holder" target="_blank"><?php echo $sitename; ?> <?php echo $plan; ?></a> <span class="icon status stat_online"><strong>
...
//			$verified = 'Profile verified.';
			$verified = "Verified : What is this?";
...
//			$verified = 'Profile not yet verified.';
			$verified = "Unverified : What is this?";
          ...
          <div class="body">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="130"><?php if($searchresultfetch['Photo1']== "nophoto.gif" or $searchresultfetch['Photo1Approve'] == 'No' ) { 
...
?></td>
            ...
            <td><div style="float:left;">:&nbsp;</div><div style="float:left; width:220px;"><?php echo $searchresultfetch['Education']; ?></div></td>
                    ...
                    <tr>
                      <th>Location</th>
                      <td>:
                        <?php if(isset($_SESSION['username']) and $_SESSION['status'] != '' and  $_SESSION['status'] != 'Active') echo $searchresultfetch['Address'].", "; ?>
