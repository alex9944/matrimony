...
$receiever = $_SESSION['matriid'];




$select_messages = "SELECT * FROM sendmessage where receiver = '$receiever'"; 
$res = mysql_query($select_messages);

$select_inbox = mysql_query("select count(*)  as inbox_cnt from sendmessage where receiver = '$receiever'");
$inbox_count = mysql_fetch_array($select_inbox);
$inbox_count1 = $inbox_count["inbox_cnt"];


$select_sent = mysql_query("select count(*)  as inbox_cnt from sendmessage where sender = '$receiever'");
  ...
  <div id="content_area">
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <div class="body">  Please note that messages will be automatically deleted from your mailbox after 60 days. If you want to keep your messages for longer, please save them on to your computer by cutting and pasting them into a suitable document. ? Want to find out more about your mailbox features? Check our <A href="faq.php">FAQ's</A> for useful tips
...
<div id="blockQuestion">
						...
						<div id="textAfterQuestion">
							<p id="readMore">&nbsp;&nbsp;&nbsp;&nbsp;Read more about sending messages <a href="/static/faq/faq.do" id="redLink">here</a></p>
						</div>
				  </div>	
				  </td>
...
<table cellspacing="0" cellpadding="0" border="0" id="scheise">
					<tbody><tr style="height:25px;" id="forHeader" class="stringColor">
						<td height="25">&nbsp;</td>
						<td width="20" align="left"><!--<img src="images/icons/mailboxStatuses/mails.gif">--></td>
 ...
 ?>
					...
					<tr class="stringColor">
					  ...
					  <td width="60">
					  	<div align="center">
							<a onclick="return confirm('Are you sure?');" href="messsagedelete.php?id=<?=$result["id"]?>"><img border="0" src="images/record_Delete.gif"></a>							</div>					  </td>
					</tr>
