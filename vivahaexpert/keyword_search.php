...
<script language="javascript" src="js/keywordsearch.js"></script>
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <h2 class="float_left title">
          ...
          <span style="color:#333;" class="black">Matrimonial - </span>Keyword Search
        ...
        <div class="body">
          ...
          <table cellspacing="5" cellpadding="5" border="0" width="100%">
	        ...
	        <tbody><tr>
    	        ...
    	        <td width="80" height="80"><img align="left" width="64" vspace="10" hspace="10" height="64" src="images/icons/search/search_page.png"></td>

                <td>Search based on a Keyword criteria one would look for in a   partner. Results can be viewed as Thumbnail View, Full View. If you like a profile you can Express Interest or Send Mail.</td>

            </tr></tbody>

          </table>

          <form action="kwsearch_results.php" method="get" name="MatriForm" id="MatriForm">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="2" class="tbl_profiledetails">
              ...
              <tr class="hline2">
                ...
                <td><div align="left">
                    ...
                    <input name="gender" type="radio" value="Male" <? if($_SESSION['gender']=='Female') {  ?>  checked="checked" <? } if(!isset($_SESSION['gender'] ) ) echo "checked"; ?>>
                    ...
                    <input name="gender" type="radio" value="Female" <? if($_SESSION['gender']=='Male') {  ?>  checked="checked" <? } ?> >
...
<!--              <tr class="hline2">
              ...
              <tr class="hline2">
                ...
                <td><div align="left">
                    ...
                    <INPUT name="txtkey" class="textbox1" id="txtkey" maxLength="50" style="width:213px;">
              ...
              <tr class="hline2">
                ...
                <td><div align="left">
                    ...
                    <!--<input name="Submit" type="image" value="Submit" src="pics/search-button.gif" onclick="return validate();">-->

                  

				  <input class="button-small square-orange uppercase" style="clear:both; border:0px; text-align:center; width:75px;" name="Submit" type="image" value="Search" onclick="return validate();">
