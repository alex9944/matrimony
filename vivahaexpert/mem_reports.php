...
{
$sql = mysql_query("SELECT * FROM register where Status ='InActive' order by ID desc "); 
}
else if ($status =='Featured')
{
$sql = mysql_query("SELECT * FROM register where Status ='Featured' order by ID desc  "); 
}
else 
{
//echo 'hi';
$qry = "SELECT * FROM register  ORDER BY ID DESC order by ID desc";
$sql = mysql_query($qry); 
}
			  ...
			  <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				<thead>
					 <tr>
					  ...
					  <th width="16%" ><strong>Full View </strong></th>
					  </tr>
				</thead>
				<tbody>						
					<? $i = 1; 
