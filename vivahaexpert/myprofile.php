...
<?php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">My Profile</span>
    ...
    <div id="inner_right">
      ...
      <div class="profile_block">
        ...
        <div class="header">
          ...
          <h3 class="float_left title">My Profile</h3>
...
<div align="left">
          ...
          <tr>
            ...
            <td>:&nbsp;<? $mother_tonque = array("1"=>"Arunachali","2"=>"Assamese","3"=>"Awadhi","4"=>"Bengali","5"=>"Bhojpuri","6"=>"Brij","7"=>"Bihari","53"=>"Badaga","8"=>"Chatisgarhi","9"=>"Dogri","10"=>"English","11"=>"French","12"=>"Garhwali","13"=>"Garo","14"=>"Gujarati","15"=>"Haryanvi","16"=>"Himachali/Pahari","17"=>"Hindi","18"=>"Kanauji","19"=>"Kannada","31"=>"Malayalam","47"=>"Tamil"); echo $mother_tonque[$row['Language']]; ?> </td>
...
?></td>
          ...
          <tr>
            ...
            <td style="display:none;">Drink</td>

            <td style="display:none;">:&nbsp; <? echo $row['Drink']; ?></td>
          ...
          <tr>
            ...
            <td>:&nbsp; <?php
			 ...
			 if(is_numeric($row['PE_Caste'])) {
				$caste_sql = "SELECT cName FROM castedata WHERE cId = '".$row['PE_Caste']."'";
				$caste_exec = mysql_query($caste_sql);
				$caste_fetch = mysql_fetch_array($caste_exec);
				echo $caste_fetch["cName"];
			}
...
<div align="left">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_profiledetails">
          ...
          <tr>
            ...
            <td width="25%" style="vertical-align:top;">Hobbies</td>

			<td width="25%" style="vertical-align:top;" ><span style="float:left; margin-right:8px;">:</span><span style="float: left; width: 140px;"><? $hobbies = $row['Hobbies'];
			if(isset($hobbies))
			 {
			   $hob_list  = explode(",",$hobbies);
			   for($i=0;$i<count($hob_list);$i++)
			    {
				  $newlist[]  = $hob_list[$i];
				}
			   echo $newhob = implode(', ',$newlist);	
			 }
			 ?></span></td>

           

            <td width="25%" style="vertical-align:top;">Interests</td>

            <td style="float:left;"><span style="float:left; margin-right:8px;">:</span><span style="float: left; width: 140px;"><? echo $row['Interests']; ?></span></td>
