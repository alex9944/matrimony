...
$sql  = "SELECT *,Left(message,30) as text from sendmessage Where receiver= '$strid' order by id desc LIMIT $from, $max_results ";
$sql = mysql_query($sql);
?>
<div id="wrapper"> 
      ...
      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
          ...
          <tr>
            ...
            <?php
$total_results =  mysql_result(mysql_query("SELECT COUNT(*) as Num FROM sendmessage Where receiver= '$strid' "),0); 
	if($total_results ==0)
	{
	  print "No results";
	}
...
<table  height="0" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="252"><a href="javascript:void window.open('read_receivemsg.php?fullview=Y&amp;Msgid=<?php  echo $row['id']?>&amp;recipientID=<?php echo $row['sender']?>','','height=468,width=600,resizable=yes,scrollbars=no')"><strong><?php  echo $row['text']?> ...</strong></a></td>
