...
document.getElementById('txttimezone').value=result[2];
});
}
...

{
...

	{
		...
		$msg = "Horoscope Generated Successfully.";
...
<div class="col-md-9">
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
		...
		<td><div align="left">Country of Birth </div></td>
	...
	<td><div style="float:left;">:</div><div align="left" id="country_aj" style="float:left;">
	...
	<?php } ?>
			  ...
			  <tr class="hline2">
                ...
                <td><div style="float:left;">:</div><div align="left" id="state_aj" style="float:left;"> 
...
<option value=" " selected>-- Select --</option>
			  ...
			  <tr class="hline2">
                ...
                <td><div style="float:left;">:</div><div align="left" id="city_aj" style="float:left;">  <select name="City" class="forminput" id="select_city" style="width:220px;" onChange="get_position(this.value);" >
