...

{
	...
	window.location.href = 'occusearch_results.php?page='+pageno+linktext;
...
$link = "&txtGender=".$_REQUEST["txtGender"]."&txtSAge=".$_REQUEST["txtSAge"]."&txtEAge=".$_REQUEST["txtEAge"]."&txtOccu=".$_REQUEST["txtOccu"]."&religion=".$_REQUEST['religion']."&caste=".$_REQUEST['caste']."&Country=".$Country."&State=".$State."&txtphoto=".$_REQUEST["txtphoto"];
...
<div class="profile_block <?php if($pre_count > 0) echo 'profile_block_featured'; ?>">
 ...
 <!--<span class="icon status stat_online">Active: <strong>Online Now</strong></span> --><?php include("include/chat.php"); ?>
