...
if(isset($_POST['to_matriid'])) {
 
  
$to_matriid = $_POST['to_matriid'];
$subject = addslashes($_POST['subject']);  
$body = addslashes($_POST['body']); 

  $insert = "INSERT INTO `sendmessage` ( `receiver`, `sender`, `subject`, `message`, `date_sent`) VALUES ('$to_matriid', '$sender', '$subject', '$body', now());"; 
...
//$to  = 'ssaguner@gmail.com'; // note the commaw


	// subject
	$subject = 'You have a new Message Received From '.$sender;
	...
	<body>
	  <p>'.$sender.' has sent you a new message. </p>
	  <table>
		<tr>
...
<td valign=top class=style2>You are receiving this mail as a registered member of '.$sitename.'. This is a computer auto generated message. Please do not Reply.</td>
	...
	$sender = $_SESSION['matriid'];
	$sms_message  = "Hi ".$nick_name.", ".$sender." has sent you a message. To view and respond to it, please visit $sitename";
...
<div id="wrapper"> 
  ...
  <div id="breadcrumb">
    <ul class="breadcrumbs">
      <li class="left"></li>
      <li class="center">
        <div id="breadcrumb_text">You are Here: <span class="pathway">  <?Php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Send Message</span> </div>
      </li>
      <li class="right"></li>
    </ul>
...
<div id="blockQuestion">
        ...
        <tr>
          <td colspan="2" id="mainContent"><div id="main">
			...
			<div id="selectedNot" style="overflow:hidden;line-height:12px"><a href="sendmessagelist.php?matriid=<?=$_REQUEST['matriid']?>" id="redLink">INBOX&nbsp;(<?=$inbox_count1?>)</a></div>
			
			
			
			
			<div id="selectedNot" style="overflow:hidden; line-height:12px"><a href="sentmessage.php?matriid=<?=$_REQUEST['matriid']?>" id="redLink">OUTBOX&nbsp;(<?=$sent_count1?>)</a></div>
				<div id="selectedNot" style="overflow:hidden; line-height:12px; width:100px;"><a href="sendmessage.php?matriid=<?=$_REQUEST['matriid']?>" id="redLink">COMPOSE MESSAGE</a></div>
...
<table width="100%" cellspacing="0" cellpadding="5" border="0" id="forMessage">
  <tbody><tr>
    ...
    <td width="84%" valign="top">
        <div id="ima" style="padding:0 390px 10px 27px">
          <input type="text" name="to_matriid" id="matriid" value="<?=$_GET['matriid']?>" size="63" height="20" style=" border-color:#F9D6A5;background-color:#FFF6EA;  width:488px;">
        </div></td>
  </tr>
  <tr>
    <td><p  align="left">Subject:</p></td>
    <td>
        <div align="left" style="padding:0 0 10px 27px">
          <input type="text" name="subject" id="subject" value="" size="63"  style=" border-color:#F9D6A5;background-color:#FFF6EA; width:488px;">
        </div></td>
  </tr>
  ...
  <tr>
    ...
    <td>
        <div align="left" style="padding:0 0 10px 27px">
          <textarea name="body" rows="20" id="body" style="width:488px; border-color:#F9D6A5;background-color:#FFF6EA"  ></textarea>
        </div></td>
  </tr>
  ...
  <tr>
    ...
    <td>
		<!-- <div style="float:left "> -->
		 <a class="pageNum" style="float:left; font-size:11px; margin-left:27px;" href="javascript:;" onclick="window.history.go(-1)"><< Go Back</a> &nbsp;&nbsp;<input class="button-small square-orange uppercase float_right" style="float:none; clear:both; border:0px;" name="submit" type="image" value="submit" alt="Send Message" onclick="return do_submit()">
