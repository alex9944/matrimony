...
<div id="wrapper"> 
  ...
  <div id="breadcrumb">
    <ul class="breadcrumbs">
      <li class="left"></li>
      <li class="center">
        <div id="breadcrumb_text">You are Here: <span class="pathway"> <?php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Profile Remove Confirm</span> </div>
      </li>
      <li class="right"></li>
    </ul>
  </div>
  ...
  <div id="content_area">
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        <div class="header">
          <h3 class="float_left title">Profile Remove Confirm</h3>
        </div>
