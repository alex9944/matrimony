			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  ?>
                                ...
                                <tr>
                                  ...
                                  <td align="center" class="bold">:</td>
                                  <td colspan="2" ><?php echo $country_name;?></td>
                                </tr>
                                <tr>
                                  <td class="bold">&nbsp;</td>
                                  <td height="30" class="bold">State</td>
                                  <td align="center" class="bold">:</td>
                                  <td colspan="2" ><?php echo $state_name;?></td>
                                </tr>
                                <tr>
                                  <td class="bold">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td align="center" class="bold">:</td>
                                  <td colspan="2"><?php echo '<a target="_blank" class="siteLink" href="mailto:'.$view_email.'">'.$view_email.'</a>';?></td>
                                </tr>
                                <tr>
                                  <td class="bold">&nbsp;</td>
								...
								<tr>
                                  <td class="bold">&nbsp;</td>
                                  <td height="30" class="bold"><input type="Button" onclick="location.href='editprofile.php'" value="Update Profile" /></td>
                                  <td align="center" class="bold"></td>
