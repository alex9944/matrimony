  ...
  <div class="contend_main">
    ...
    <div class="con_rgt">
			...
			<div class="in_head">
				<div class="in_head">
					<div class="in_head">
						<div class="head_txt">Help</font></div>
					</div>
				</div>
			</div>
			...
			<?php 
				...
				echo $site_about_value['help_content'];
			?>
			</div>
			<div class="text_botem">
				If you any othey query feel free to <a href="contact_us.php">contact us</a>
			</div>
			<div class="clr"></div>
			</div>
			<div class="b">
