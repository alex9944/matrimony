...
$categorysql11=mysql_fetch_array(mysql_query("select * from class_2daydiscount where d_id='$searchkey' and d_status='1' order by d_id desc"));
/*echo "select * from class_2daydiscount where d_id='$searchkey' and d_status='1' order by d_id desc";*/

$categorysql1=mysql_fetch_array(mysql_query("select * from class_category where c_id='$categorysql11[d_category]'"));

$subcategorysql=mysql_fetch_array(mysql_query("select * from class_subcategory where sid='$categorysql11[d_subcategory]'"));

$post_query=mysql_query("select * from class_2daydiscount where d_category='$subcategorysql[cid]' and  d_status='1'");
...
$categorysql11=mysql_fetch_array(mysql_query("select * from class_2daydiscount where d_id='$searchkey'"));



$contact_mail=$categorysql11['d_conemail'];

$contact_name=$categorysql11['d_conname'];

$sid=base64_encode($categorysql11['d_id']);
$vname=str_replace(" ","-",$categorysql11['d_title']." ".$sid);
...
if (($_FILES["file"]["type"] == "application/msword")|| ($_FILES["file"]["type"] == "application/pdf"))
  ...
  if($categorysql11['d_category']==12)
   {
...
<table width=\"566\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" style=\"border:2px solid #EFF2F2;padding:20px\">
<tr>
<td><a href=\"$site_url\" target=\"_blank\">
<img  src=\"$sitelogo\" border=\"0\" width='188' height='81'></a></td>
</tr>
...
echo $header;exit;*/
   ...
   header("location:discount_view.php?errmsg=1&cname=$categorysql1[c_name]/$vname");
}
  ...
  <div class="contend_main">
    ...
    <div class="con_lft">
		...
		<div class="element-box">
			<div class="t">
				<div class="t">
					<div class="t" style="height:30px;"></div>
				</div>
			</div>
			<div class="m" style="height:220px;">
      ...
      <div class="element-box">
        ...
        <div class="m" style="">
          <?php include("includes/left2daydiscountlist.php");?>
        </div>
        <div class="b">
          <div class="b">
            <div class="b"></div>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="color: #333333;font-size: 12px;">
                            ...
                            <?php
				$dateexp=explode("-",$categorysql11['d_date']);
...
<tr>
<td><a href=\"$site_url\" target=\"_blank\">
<img  src=\"$sitelogo\" width=\"188\" height=\"81\" border=\"0\"></a></td>
</tr>
<tr><td style=\"background:#0195C5;height:5px;\"></td></tr>
<tr><td>
<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" align=\"left\" style=\"color:#333333;margin-top:20px;\">
...
<tr><td colspan=\"2\">I came across this post at $sitename Classifieds and thought you might be interested. Have a look.
 <br/><br/></td></tr>
                              ...
                              <td colspan="3"><table>
                                <tr>
                                    <td valign="top" align="justify"><div id="gallery">
                                        <?php if(($categorysql11['d_photo1'] != "") && (file_exists("admin/uploads/".$categorysql11['d_photo1']))) { $photoct = 1; ?>
                                        <a title="<?php echo ucfirst($categorysql11['d_title']);  ?>" href="<?php echo $categorysql11['d_photo1']; ?>"><img style="border:1px solid #E4E4E4;padding:2px;" src="admin/uploads/<?php echo $categorysql11['d_photo1']; ?>" height="100" width="100" /></a>
                                        <div style="display:none;">
                                          <?php if(($categorysql11['d_photo2'] != "") && (file_exists("admin/uploads/".$categorysql11['d_photo1']))) { $photoct = 2; ?>
                                          <a title="<?php echo ucfirst($categorysql11['d_title']); ?>" href="<?php echo $categorysql11['d_photo2']; ?>"><img src="admin/uploads/<?php echo $categorysql11['d_photo2']; ?>" height="100" width="100" /></a>
                                          <?php } ?>
                                          <?php if(($categorysql11['d_photo3'] != "") && (file_exists("admin/uploads/".$categorysql11['d_photo1']))) { $photoct = 3; ?>
                                          <a title="<?php echo ucfirst($categorysql11['d_title']); ?>" href="<?php echo $categorysql11['d_photo3']; ?>"><img src="admin/uploads/<?php echo $categorysql11['d_photo3']; ?>" height="100" width="100" /></a>
                                          <?php } ?>
                                          <?php if(($categorysql11['d_photo4'] != "") && (file_exists("admin/uploads/".$categorysql11['d_photo1']))) { $photoct = 4; ?>
                                          <a title="<?php echo ucfirst($categorysql11['d_title']); ?>" href="<?php echo $categorysql11['d_photo4']; ?>"><img src="admin/uploads/<?php echo $categorysql11['d_photo4']; ?>" height="100" width="100" /></a>
                                          <?php } ?>
                                        </div>
                                      <br />
                                  ...
                                  <td></td>
                                  <td valign="top" colspan="2" align="justify" style="line-height:20px;"><?php $c=$categorysql11['d_city'];
				 $city = mysql_query("select * from class_city where cityid='$c'");
				 $fetch=mysql_fetch_array($city);?>
                                        <span style="color: #F94D01;font-size: 12px;"><strong><?php echo ucfirst($categorysql11['d_title']); ?></strong></span>&nbsp;&nbsp;-&nbsp;&nbsp;<?php echo $categorysql1['c_name'];?>/<?php echo $subcategorysql['subcategoryname']; ?><br />
                                        <?php if($categorysql11['d_price'] != 0) echo '<strong>Price</strong> : '.$currency.$categorysql11['d_price'].'<br />'; ?>
                                        <?php echo '<strong>Description</strong> : '.$categorysql11['d_description']; ?><br /><span class="sub_title"><strong>City</strong> : </span><?php echo $categorysql11['d_city'].', '.get_state($categorysql11['d_state']);?><br />  
                                        <?php $stid = $categorysql11['d_state']; $state = mysql_fetch_array(mysql_query("select state_name from class_state where stateid='$stid'")); ?>
					...
					?>
                                        <?php echo '<strong>Contact person</strong> : '.$categorysql11['d_conname']/*.'<br /><span style="padding-left:20px;"></span>'.$categorysql11['d_conemail'].'<br /><span style="padding-left:20px;"></span>'.$categorysql11['d_conno']*/; ?> </td>
                                </tr>
                              </table></td>
					   ...
					   ?>
									...
									<tr>
										...
										<td valign="middle" align="left" class="text">
											<input type="text" id="txtCaptcha" style="background-image:url('images/secure.jpg'); text-align:center; border:none; font-weight:bold; font-family:Modern; margin-left:15px; height:25px; width:55px;" readonly="readonly"/>
											<img src="images/refresh.png" id="btnrefresh" onClick="DrawCaptcha()" style="margin-left:10px;"/>
											<input type="hidden" id="txtCaptcha"  style="text-align:center; border:none; font-weight:bold; font-family:Modern"/> 
                                    ...
                                    <tr>
                                      <td align="center" colspan="3">
									  	<input name="searchsubmit" type="submit" class="but_bg" value="Send" />
									</td>
                                    </tr>
                                  </table>
                              </form></td>
								<td align="left" valign="top" width="338" height="280">
								<?php include("includes/bodyad.php"); ?>
							  <table width="100%">
							  <tr>
							  <td>
<?php 
...
$city=trim($categorysql11['d_city']);
$state=trim(get_state($categorysql11['d_state']));
$country=trim(get_country($categorysql11['d_country']));

$locate=str_replace(" ","+","$city,+$state,+$country");
?>
