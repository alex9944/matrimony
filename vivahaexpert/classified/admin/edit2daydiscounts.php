...
$detail1=mysql_fetch_array(mysql_query("select * from `class_2daydiscount` where `d_id`='$d_id'"));

$creg_profile1=mysql_fetch_array(mysql_query("select * from class_2daydiscount where d_id='$d_id'"));
...
$uploadQuery = "update class_2daydiscount SET 
d_category='$category',
d_subcategory='$subcategory',
...
header("location:2daydiscounts.php");
...
var title=document.postForm.title.value;
			...
			if(document.postForm.address.value=="")
			{
			  		...
			  		alert("Please Select You raddress");
...
var state1=document.postForm.state.value;
			if(state1=="")
			{
...
var city1=document.postForm.city.value;
			if(city1=="")
			{
...
var conphone=document.postForm.conno.value;
			if(conphone=="")
			{
					alert("Please Enter Your Phone Number");
					document.postForm.conno.focus();
					return false;
			}	
			if(isNaN(conphone))
			{
            ...
            <tr>
              ...
              <form action="" method="post" enctype="multipart/form-data" name="postForm" id="form1" onsubmit="return postCheck();">
                  ...
                  <tr>
                    ...
                    <td>
						...
						<?php while($cat=mysql_fetch_array($sta1)) { ?>
                           ...
                           <option value="<?php echo $cat['c_id']?>" <?php if($cat['c_id']==$detail1['d_category']) { ?> selected="selected"<?php } ?> ><?php echo $cat['c_name']; ?></option>
                            <?php  } ?>
                    </select> </td>
                  </tr>
                  <tr>
               ...
               <select name="subcategory" class="combo_box">
				...
				{?>
				<option value="<?php echo $fetch_areg['sid']; ?>"<?php if($detail1['d_subcategory']==$fetch_areg['sid'] ){ ?> selected="selected" <?php } ?>><?php echo $fetch_areg['subcategoryname']; ?></option>
				<?php } ?>
			</select>    
			</div>                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input name="title" type="text" id="title" class="text_box" value="<?php echo $detail1['d_title'];?>" /></td>
                  </tr>
				  <tr>
                  <td class="bold">Price</td>
                  <td align="center" class="bold">:</td>
                  <td><input name="price" type="text" maxlength="12" value="<?php echo $detail1['d_price'];?>" id="pricess" class="text_box" onblur="space(this.id)" style="width:150px;" />
                      </td>
                </tr>
				 <tr>
                  <td class="bold">Address</font></td>
                  <td align="center" class="bold">:</td>
                  <td><input name="address" type="text"  id="address" value="<?php echo $detail1['d_address'];?>" class="text_box" onblur="space(this.id)"/></td>
                </tr>
				  <!--<tr>
                    ...
                    <!--  <option value="">Select Country</option>
						...
						<option value="">Select Country</option>
		                  <?php while($con2=mysql_fetch_array($cont)) {?>
                           <option value="<?php echo $con2['countryid'];?>"<?php if($con2['countryid']==$detail1['d_country']) { ?> selected="selected"<?php } ?> ><?php echo $con2['country'];?></option>
                            <?php } ?>
                    </select>  </td>
                  </tr>-->
				   ...
				   <tr>
                    ...
                    <td>
					  ...
					  <div id="statenew">
							...
							<option value="<?php echo $stat['stateid'];?>" <?php if($detail1['d_state'] == $stat['stateid']) {?>  selected="selected"<?php } ?> ><?php echo $stat['state_name'];?></option>
							<?php } ?>
							</select>
						</div>
					</td>
				  ...
				  <tr>
                    ...
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input name="city" type="text" id="city1" class="text_box" onblur="space(this.id)" value="<?php echo $detail1['d_city'];?>" /></td>
                  </tr>
         ...
         <?php /*         <tr>
			  ...
			  <option value="<?php echo $state12['stateid'];?>"<?php if($state12['stateid']==$detail1['p_state']) { ?> selected="selected"<?php } ?> ><?php echo $state12['state_name'];?></option><?php }?>
                  ...
                  <tr>
                    ...
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td align="left" ><label><textarea name="description" id="description" class="text_area" cols="30" rows="3" onblur="space(this.id)"><?php echo $detail1['d_description'];?></textarea></label></td>
                  </tr>
                 <!-- <tr>
				  ...
				  <tr>
                    ...
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td width="40"><input name="photo1" type="file" id="photo1" value="<?php echo $detail1['d_photo1']?>" /></td>
					<td><span class="ad_text"><img src="<?php echo $detail1['d_photo1']; ?>" width="40" height="40" /></span></td>
                  </tr>
				  <tr>
                    <td class="bold">Photo2</td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input name="photo2" type="file" id="photo2" /></td>
					<td><span class="ad_text"><?php if(file_exists($detail1['d_photo2'])) {?><img src="<?php echo $detail1['d_photo2'];?>" width="40" height="40" /></span><?php } else { ?><img src="images/NOIMAGE.jpeg" height="40" width="40"/><?php }?></td>
                  </tr>
				  <tr>
                    <td class="bold">Photo3</td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input name="photo3" type="file" id="photo3" /></td>
					<td><span class="ad_text"><?php if(file_exists($detail1['d_photo3'])) {?><img src="<?php echo $detail1['d_photo3'];?>" width="40" height="40" /></span><?php } else { ?><img src="images/NOIMAGE.jpeg" height="40" width="40"/><?php }?></td>
                  </tr>
				  <tr>
                    <td class="bold">Photo4</td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input name="photo4" type="file" id="photo4" /></td>
					<td><span class="ad_text"><?php if(file_exists($detail1['d_photo4'])) {?><img src="<?php echo $detail1['d_photo4'];?>" width="40" height="40" /></span><?php } else { ?><img src="images/NOIMAGE.jpeg" height="40" width="40"/><?php }?></td>
                  </tr>
                  <tr>
                    <td colspan="2">&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td class="bold">Contact Name<font color="#FF0000" >*</font> </td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input type="text" name="conname"  id="conname" value="<?php echo $detail1['d_conname'];?>"  onblur="space(this.id)" class="text_box"/></td>
                  </tr>
                  <tr>
                    <td class="bold">Contact Email<font color="#FF0000">*</font> </td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input type="text" name="conemail"  id="conmail"value="<?php echo $detail1['d_conemail'];?>"  onblur="space(this.id)" class="text_box"/></td>
                  </tr>
                  <tr>
                    <td class="bold">Contact Number<font color="#FF0000">*</font> </td>
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input type="text" name="conno" id="conno"  value="<?php echo $detail1['d_conno'];?>" class="text_box" onblur="space(this.id)"/></td>
                  </tr>
                  <tr>
                    <td height="80" colspan="3" align="center">
					 ...
					 <input name="edit_form"  type="submit"  value="Update" />
					  </td>
                    </tr>
					<tr><td align="right" colspan="4"><span class="ad_text_color"><a href="2daydiscounts.php" class="link1">Back </a></span></td>
					</tr>
                </table>
