              ...
              <tr>
                ...
                <td bgcolor="#fef5fa"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					?>                                        </td>
                                      ...
                                      <tr>
                                        <td class="bold">Address<font color="#FF0000" size="-4">*</font></td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                      ...
                                      <tr>
                                        <td class="bold">Phone Numer<font color="#FF0000" size="-4">*</font></td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $reg_phone;?></td>
                                      </tr>
                                      <tr>
                                        <td class="bold">Website<font color="#FF0000" size="-4">*</font></td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $reg_website;?></td>
                                      </tr>
...
<td  class="bold"> <span class="ad_text_color" ><?PHP
		  $userid_admin=$view_fetch['reg_id']; 
