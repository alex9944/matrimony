...
if($count!=0)
{
mysql_query("update sitesetting set privacy_content='$descr'");
}
else
{
if(mysql_query("INSERT INTO sitesetting(privacy_content)values('$descr')"))
{
echo "<font>('Your Description added successfully');</font>";
}
else
{
echo "failed to add privacy content";
}
}
}
	...
	<tr>
		<td height="223" colspan="2">
			<table width="83%" align="center" cellspacing="0" style="border:solid 1px #669966;">
				<tr>
				  <td height="27" bgcolor="#edcfde" class="link1">Privacy policy content</td>
				...
				<tr><td valign="top" bgcolor="#faf3f7">
					<form name="termtext" action="" method="post" onsubmit="return validate();"><table width="372" height="79" align="center" cellspacing="0" style="border:0px solid #D8F1E4;">
						...
						<tr class="normal" bgcolor="#faf3f7">
						  ...
						  <?php $select_text=mysql_query("SELECT `privacy_content` FROM sitesetting"); 
						  $fetch_text=mysql_fetch_array($select_text);
						  ?>
						    <textarea name="term" id="term" rows="25" cols="80"><?php echo stripslashes($fetch_text['privacy_content']) ?></textarea>
						  </td>
						</tr>
						<tr>
							<td>&nbsp;
