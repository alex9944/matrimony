...
<table width="98%" border="0" cellpadding="3" cellspacing="1" align="center">
 ...
 <!-- <tr>
  ...
  <tr>
    <td width="35%">&nbsp;</td>
   <td width="11%" align="center" bgcolor="#faf3f7"><a href="edithotlisting.php?p_id=<?php echo $view_fetch['p_id'];?>"><img src="images/edit_f2.png" width="32" height="32" border="0" title="Edit"/></a></td>
...
return false;" /></td> -->
    <td width="33%" class="bold"><?PHP
		  ...
		  {
		  ?>
        <a href="managehotlisting.php?inactid=<?php echo $userid_admin;?>" class="ad_text_color"
