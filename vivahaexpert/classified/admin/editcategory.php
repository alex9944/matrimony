...
$result=mysql_query("select * from class_category where c_id='$cateid'");
...
if(isset($_REQUEST['editcat']))
{
	...
	mysql_query("update class_category set c_name='$catname' where c_id='$cateid'");
				...
				<tr><td valign="top" bgcolor="#faf3f7">
					<form name="addcategory" enctype="multipart/form-data" method="post" onsubmit="return val();"><table width="400" height="79" align="center" cellspacing="0" style="border:1px solid #D8F1E4;">
						...
						<tr class="normal" bgcolor="#faf3f7">
						  ...
						  <td width="195" align="">
						    <input name="category" type="text" id="category" class="text_box" value="<?php echo $final['c_name'];?>" />
						  </td>
						</tr>
						<tr class="normal" bgcolor="#faf3f7">
						  <td width="171" class="link1">&nbsp;&nbsp;Categroy Image</td>
						  <td width="195" align="">
						  	<?php if($final['c_filetype'] != '') { ?>
								<img style="padding:10px;" src="../images/category_icon/<?php echo $final['c_id'].'.'.$final['c_filetype'];?>" width="34" height="26" alt="" />
							<?php } ?>
