...
if($count!=0)
{
mysql_query("update sitesetting set aboutus_content='$descr'");
}
else
{
if(mysql_query("INSERT INTO sitesetting(aboutus_content)values('$descr')"))
{
echo "<font>('Your Description added successfully');</font>";
}
else
{
echo "failed to add about us content";
}
}
}
	...
	<tr>
		<td height="223" colspan="2">
			<table width="83%" align="center" cellspacing="0" style="border:solid 1px #669966;">
				<tr>
				  <td height="27" bgcolor="#edcfde" class="link1">About us content  </td>
					...
					<form name="termtext" action="" method="post" onsubmit="return validate();"><table width="372" height="79" align="center" cellspacing="0" style="border:0px solid #D8F1E4;">
						...
						<tr class="normal" bgcolor="#faf3f7">
						 <td width="95%" align="center">
						  <?php $select_text=mysql_query("SELECT `aboutus_content` FROM sitesetting"); 
						  $fetch_text=mysql_fetch_array($select_text);
						  ?>
						    <textarea name="term" id="term" rows="25" cols="80"><?php echo stripslashes($fetch_text['aboutus_content']) ?></textarea>
						  </td>
						</tr>
						<tr>
							<td>&nbsp;
