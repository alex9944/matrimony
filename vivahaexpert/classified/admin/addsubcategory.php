...
header("location:index.php");
	...
	{
	 echo $category=$_REQUEST['cat'];
	  $subcat=$_REQUEST['subcat'];
	  //echo "insert into class_subcategory(cid,subcategoryname) values('$category','$subcat')";exit;
	 mysql_query("insert into class_subcategory(cid,subcategoryname) values('$category','$subcat')");
	...
	<tr>
		<td height="223" colspan="2">
			<table width="77%" align="center" cellspacing="0" style="border:solid 1px #edcfde;">
				<tr>
				  <td height="27" bgcolor="#edcfde" class="link1">Add New Sub Category </td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				</tr>
				<tr><td valign="top">
					...
					<tr class="normal">
						  <td class="inTxtNormal">&nbsp;&nbsp;<strong>Category Name</strong> </td>
						  <td align="left"><select name="cat" id="cat" class="combo_box">
						  ...
						  ?>
						  <option value="<?PHP echo $catresult['c_id'];?>"><?PHP echo $catresult['c_name']; }?></option>
					  ...
					  <tr>
						...
						<tr >
						  <td width="171" class="inTxtNormal">&nbsp;&nbsp;<strong>Subcategory Name</strong> </td>
						  <td width="195" align="left">
					        <input name="subcat" type="text" id="subcat" class="text_box"/>						  </td>
						</tr>
					   <tr>
						<td align="right">&nbsp;</td>
					   </tr>
