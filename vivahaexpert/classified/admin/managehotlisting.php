...
//echo $message;die();
 ...
 header("location:managehotlistings.php?success=1");
...
<table width="98%" border="0" cellpadding="3" cellspacing="1" align="center">
        ...
        <td colspan="6" height="50" valign="middle" class="head_bg"><b>Post Classified Management</b></td>
					...
					<tr><td colspan="12">&nbsp;</td></tr>				  
		                  ...
		                  while($con1=mysql_fetch_array($sta1)) {?>
									   ...
									   <td> <strong>Subcategory :</strong> 
									   <span id="scat_id"><select name="subcat_id" style="width:110px;">
									  <option value="">-Select Subcategory -</option>
									   ...
									   <td><strong>Sort Order :</strong>  <select name="sort_order" style="width:110px;">
  ...
  <strong> From : &nbsp;</strong>
	...
	<link rel="stylesheet" href="calendar.css"><script language="JavaScript">
	new tcal ({
		// form name
	...
	</script> <!--<br /><span style="padding-left:110px;"> <a href="Javascript:void(0);" onclick="date_clear()">Clear</a></span>-->		</td>
...
<input type="text" readonly="true"  value="<?php echo $_REQUEST['txttoregdt'];?>" name="txttoregdt" size="12"  id="txttoregdt"  /><script language="JavaScript" src="calendar_us.js"></script>
	...
	</script>&nbsp;<span style="padding-left:0px;"> <a href="Javascript:void(0);" onclick="date_clear()">Clear</a></span></td>
	<td valign="top"> <strong>Status : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> <select name="status" style="width:110px;">
  ...
  <?php
   ...
   $strget=""; 
     $sel_enq = "select * from `class_postclassified`  where `p_hotlisting`='1' ";
									   $str_qry="";
									   $temp_qry="";
 ...
 // echo $select_User;
  ...
  <input type="checkbox" name="box[]"  id="box[]" value="<?php echo $reg_fetch['p_id']; ?>" />
  </td>
   <td bgcolor="#faf3f7" class="welcome_text" align="center"><?php echo $i;?></td>
    ...
    <td align="center" bgcolor="#faf3f7"><a href="edithotlisting.php?p_id=<?php echo $reg_fetch['p_id'];?>"><img src="images/edit_f2.png" width="25" height="20" border="0" title="Edit"/></a></td>
    <!--<td bgcolor="#faf3f7"><?php echo $reg_fetch['p_date'];?></td>-->
    <td bgcolor="#faf3f7">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="bottom"><a href="managehotlisting.php?delid=<?php echo $reg_fetch['p_id'];?>"><img  src="../images/delete_x.jpg"class="button" value="Delete" onclick="if( confirm('Are you sure you want to Delete this Record?') )
						{
   ...
   <!-- <td align="center" bgcolor="#faf3f7" class="ad_text_color"><a href="viewclassified.php?viewid=<?php echo $reg_fetch['p_id'];?>"><img src="images/view_icon.jpg" width="25" height="20" border="0" title="View"/></a></td> -->
    <td bgcolor="#faf3f7" align="center"><?PHP
		  ...
		  {
		  ?>
        <a href="managehotlisting.php?inactid=<?php echo $userid_admin;?>" class="ad_text_color" onclick="if( confirm('Are you sure you want to Inactivate this Record?') )
			{
			return true;
			}
			else
	 ...
	 <!-- demo <a href="manageclassified.php?inactid=<?php //echo $userid_admin;?>" class="ad_text_color" style="text-decoration:none;" onclick="return editfun()">Inactivate</a> -->
        <?php } if($activate==0){?>
        <a href="managehotlisting.php?actid=<?Php echo $userid_admin;?>" class="ad_text_color" onclick="if(confirm('Are you sure you want to Activate this Record?') )
								{
								 return true;
								}
								else
  ...
  <tr><td colspan="11">  <input type="submit" value="Compose" name="compose" title="Compose Mail" onclick="return submit_chk();" />
  <div id="sendmail"  style="overflow:visible; width:455px; background:#ffe1f1 ;  display:none; position:absolute; height:330px; top:500px; left:250px; border:10px solid #D26095;"> 
	...
	<table width="100%" border="0" cellpadding="4" cellspacing="2">
			<tr><td colspan="4" align="right"><img src="images/delete2.jpg" title="Cancel" border="0" onClick="javascript:showdiv('sendmail')"  /></td>
		<tr><td colspan="4" height="20" align="center" valign="top" style="padding-left:10px; font-size:12px;" class="link1">&nbsp;&nbsp; Send Email</td>
		</tr>
  ...
  <tr>
    <td height="25" colspan="4" align="left" valign="middle"  style="padding-left:120px"><input name="btnsendmail" type="submit" value="Send Mail" class="butSub" onClick="javascript:return frmemailvalidation();" />  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="btncancel" class="butSub" type="button" value="Cancel" onClick="javascript:showdiv('sendmail')" /></td>
    </tr>
</table>
  </form>
	</div>
