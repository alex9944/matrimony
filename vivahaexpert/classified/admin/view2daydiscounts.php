...
$country_id=$view_fetch['d_country'];
...
<table width="98%" border="0" cellpadding="3" cellspacing="1" align="center">
 ...
 <!-- <tr>
              ...
              <tr>
                ...
                <td bgcolor="#fef5fa"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="left" valign="top" ><form action="manageuser.php?delid=<?php echo $view_fetch['d_id'];?>" method="post" enctype="multipart/form-data" name="postForm" id="form1" onsubmit="return postCheck();">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" style="border:solid 1px #0F507F;">
                                      <tr>
                                        <td colspan="3" align="right" class="bold"><a href="2daydiscounts.php" class="ad_text_color">Back</a></td>
                                      </tr>
                                      <tr>
					...
					?>                                        </td>
                                      ...
                                      <tr>
                                        <td width="37%" class="bold">Category </td>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $view_fetch['d_title'];?></td>
                                      </tr>
									  <tr>
                                        <td class="bold">City</td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_city'];?></td>
                                      </tr>
									   <tr>
                                        <td class="bold">State</td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_state'];?></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_description'];?>                                       </td>
                                      </tr>
                                     <?php 
										$image=$view_fetch['d_photo1'];
										if($image!="")
										{
										$mage_res="".$image;
										}
                                      ...
                                      <tr>
                                        ...
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_conname'];?></td>
                                      </tr>
                                      <tr>
                                        <td class="bold">Contact Email </td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_conemail'];?></td>
                                      </tr>
                                      <tr>
                                        <td class="bold">Contact Number </td>
                                        <td align="center" class="bold"><strong>:</strong></td>
                                        <td><?php echo $view_fetch['d_conno'];?></td>
                                      </tr>
  ...
  <tr>
    <td width="35%">&nbsp;</td>
   <td width="11%" align="center" bgcolor="#faf3f7"><a href="edit2daydiscounts.php?d_id=<?php echo $view_fetch['d_id'];?>"><img src="images/edit_f2.png" width="32" height="32" border="0" title="Edit"/></a></td>
...
return false;" /></td> -->
    <td width="33%" class="bold"><?PHP
		  $userid_admin=$view_fetch['d_id']; 
		  $activate=$view_fetch['d_status'];
		  if($activate==1)
		  {
		  ?>
        <a href="2daydiscounts.php?inactid=<?php echo $userid_admin;?>" class="ad_text_color"
	  ...
	  <!-- demo <a href="manageclassified.php?actid=<?Php //echo $userid_admin;?>" class="ad_text_color" style="text-decoration:none;" onclick="return editfun()">Activate</a> -->
        <?php } ?>        </td>
    <td width="8%" align="right" class="bold"><span class="ad_text_color"><a href="2daydiscounts.php"> Back </a></span></td>
  </tr>
</table>
 </td>
