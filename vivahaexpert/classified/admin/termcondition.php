...
if($count!=0)
{
mysql_query("update sitesetting set termtext='$descr'");
}
else
{
if(mysql_query("INSERT INTO sitesetting(termtext)values('$descr')"))
{
	...
	<tr>
		<td height="223" colspan="2">
			<table width="77%" align="center" cellspacing="0" style="border:solid 1px #669966;">
				<tr>
				  <td height="27" bgcolor="#edcfde" class="link1">Terms and Condition </td>
				</tr>
				<tr>
				...
				<tr><td valign="top" bgcolor="#faf3f7">
					<form name="termtext" action="" method="post" onsubmit="return validate();"><table width="372" height="79" align="center" cellspacing="0" style="border:0px solid #D8F1E4;">
						...
						<tr class="normal" bgcolor="#faf3f7">
						  ...
						  ?>
						    <textarea name="term" id="term" rows="15" cols="60"><?php echo stripslashes($fetch_text['termtext']) ?></textarea>
						  </td>
						</tr>
					...
					<input name="description" type="submit" id="description" value="ADD" class="but_bg" />
