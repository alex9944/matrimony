...
<div class="header">
  <h3 class="float_left title">Invoice</h3>
</div>
<div class="body" align="left">
  <?php  while($row = mysql_fetch_array($memchk)){ ?>
  <table width="83%" border="0" align="center" cellpadding="5" cellspacing="1" class="tborder">
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#F5F5F5"><span class="bodyp">
        <?php  echo $row['Pplan']?>
        Membership for
        <?php  echo $row['Pplanduration']?>
        days</span></td>
      <td bgcolor="#F5F5F5"><div align="center">1</div></td>
      <td bgcolor="#F5F5F5"><div align="center"><span class="Partext1"> MYR.
    ...
    <tr>
      ...
      <td bgcolor="#ECE9D8"><div align="center"><span class="Partext1"> MYR.
          <?php  echo $row['Pamount']?>
          </span></div></td>
    </tr>
  </table>
