...
$sql = mysql_query("Select * from expressinterest where eisender_accept='Accept' and eireceiver='$strid' order by id desc LIMIT $from, $max_results ");
    ...
    <tr>
      ...
      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td>Listed Below are members who are <strong>Accepted </strong> your expressed interest.</td>
...
$total_results =  mysql_result(mysql_query("SELECT COUNT(*) as Num FROM expressinterest where eisender_accept='Accept' and eireceiver='$strid' "),0); 
...
?>
        ...
        <table width="100%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			Received From: <!--<a href='memprofile.php?id=<?php //echo $row['eireceiver']?>&action=ei' class="redheading2" target="_blank">

			<?php //echo $row['eisender']?></a>-->
<a href='memprofile.php?id=<?php echo $row['eisender']?>&action=ei' class="redheading2" target="_blank">
			...
			Status :  <span style="color:green;"><?php echo $row['eirec_accept']?></span> on <?php echo date("d-M-Y H:i A",$row['updated_date']); ?>  <br>
