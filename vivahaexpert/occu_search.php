...
<script language="javascript" src="js/occupationsearch.js"></script>
    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <h2 class="float_left title">
          ...
          <span style="color:#333;" class="black">Matrimonial - </span>Occupational Search
        ...
        <div class="body">
          ...
          <table cellspacing="5" cellpadding="5" border="0" width="100%">
	        ...
	        <tbody><tr>
    	        ...
    	        <td width="80" height="80"><img align="left" width="64" vspace="10" hspace="10" height="64" src="images/icons/search/prof_srch.png"></td>

                <td>Search based on a Occupation criteria one would look for in a   partner. Results can be viewed as Thumbnail View, Full View. If you like a profile you can Express Interest or Send Mail.</td>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="2" class="tbl_profiledetails">
              ...
              <tr class="hline2">
                ...
                <td><div align="left">
                    ...
                    <select name="txtOccu" id="txtOccu" style="width:215px;">
