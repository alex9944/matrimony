...
$sql = mysql_query("Select * from expressinterest where eirec_accept='Decline' and eisender='$strid' order by id desc LIMIT $from, $max_results ");
    ...
    <tr>
      ...
      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><div align="left">Listed Below are <strong>Declined</strong> your sent expressed interest.</div></td>
...
$total_results =  mysql_result(mysql_query("SELECT COUNT(*) as Num FROM expressinterest where eirec_accept='Decline' and eisender='$strid' "),0); 
...
?>
        ...
        <table width="100%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			Declined From : <a href='viewfullprofile1.php?id=<?php echo $row['eireceiver']?>' class="redheading2">
			...
			Status :  <?php if($row['eirec_accept'] == 'Decline') echo '<span style="color:red;">'.$row['eirec_accept'].'</span>'; ?> on <?php echo date("d-M-Y H:i A",$row['updated_date']); ?><br>
