...
<div class="profile_block">
  <div class="header">
    <h3 class="float_left title">Protect my phone</h3>
  </div>
  <div class="body" align="left">
    <form action="phone_protect_password_submit.php" method="post" name="form" id="form"  onSubmit="return validate()">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="content">
              <tr>
                <td align="left">If the phone is protected, then other members can not visible your phone. If anyone interested to view your phone, then they will send a request phone password to you. <br>
                  <br>
                  If you have  obtained the phone Password request then you can 'Accept/Decline' the Request. </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><div align="center">
                    <table width="374" border="0" cellpadding="2" cellspacing="2" class="tbl_profiledetails">
                      <tr>
                        <td height="19" colspan="2"><strong>&nbsp;&nbsp;Set/Reset Password to Protect your Phone</strong></td>
                      </tr>
                      <tr>
