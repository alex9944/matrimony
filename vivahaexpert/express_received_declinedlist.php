...
?>
        ...
        <table width="100%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			Declined From: <a href='viewfullprofile1.php?id=<?php echo $row['eisender']?>&action=ei' class="redheading2" target="_blank">
			...
			Status :  <span style="color:red;"><?php echo $row['eirec_accept']?></span> on <?php echo date("d-M-Y H:i A",$row['updated_date']); ?> <br>
