...

  {
  		 ...
  		 if ( document.MatriForm.txtSAge.value == "" )

		 {

			alert( "Please enter minimum age." );

			document.MatriForm.txtSAge.focus( );
		 ...
		 if ( document.MatriForm.txtSAge.value < 18 )
		...
		if ( document.MatriForm.txtSAge.value > 60 )
		 ...
		 if ( document.MatriForm.txtEAge.value == "" )
		 {
			alert( "Please enter maximum Age" );
			document.MatriForm.ta.focus( );
			return false;
		}
		if ( document.MatriForm.txtEAge.value > 60 )
		 {
			alert( "Maximum Age should be below 60" );
			document.MatriForm.txtEAge.focus( );
			return false;
		}
		if ( document.MatriForm.txtEAge.value < 18 )
		 {
