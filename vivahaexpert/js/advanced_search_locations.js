...

{
		...
		document.MatriForm.city_text.value = '';

		document.MatriForm.state_text.value = '';
		...
		document.MatriForm.state_text.disabled = true;
			...
			ex_len = document.MatriForm.State.length;

			for(k=(ex_len - 1); k > 0; k--)

			{

				document.MatriForm.State.options[k] = null;
...

			{
				...
				document.MatriForm.State.options[document.MatriForm.State.length]=option0;
...

	{
        ...
        if (document.MatriForm.country.value == 'india')

        {
        ...
        } else if (document.MatriForm.country.value == 'canada' ) {
            ...
            document.MatriForm.State.options[1].selected = true;
      ...
      if ( fld == 'united states of america')
...

		{
...

			 {
				...
				document.MatriForm.State.options[(i+1)].selected = true;	
...

		{
				...
				len = document.MatriForm.State.length;

				document.MatriForm.State.options[(len-1)].selected = true
