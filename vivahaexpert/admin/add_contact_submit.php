...
$result = mysql_query("SELECT MatriID,Name,ConfirmEmail,Noofcontacts,Status, Memshipexpirydate, horoscope_remaining, DATEDIFF( CURRENT_DATE, Memshipexpirydate ) AS expdays
				...
				{  ?>
   				...
   				<table width="600" border="0" align="center" cellpadding="5" cellspacing="0" class="submenubox" id="tbl" runat="server" visible="false">
					...
					<tr>
                      ...
                      <td class="paratext"><div align="left">Remining Astromatch : </div></td>

                      <td class="style4" ><? echo $row['horoscope_remaining']; ?></td>
