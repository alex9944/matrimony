...
<!-- 
function win(){
window.opener.location.href="update_addons.php";
self.close();
//-->
}
</SCRIPT>
...
<table width="400" height="400" border="0" cellpadding="0" cellspacing="0" class="GreenBox">
  <tr>
    <td>
	<?php //print_r($_POST); ?>
	<form action="addons_confirm_submit.php" method="post">
	<input type="hidden" name="matri_id" value="<? echo $_POST['matri_id']; ?>" />
	<input type="hidden" name="astro_match" value="<? echo $_POST['astro_match']; ?>" />
	<input type="hidden" name="profile_spotlight" value="<? echo $_POST['profile_spotlight']; ?>" />
	<input type="hidden" name="astro_match_count" value="<? echo $_POST['astro_match_count']; ?>" />
	
	<table width="100%" height="400" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
	
      <tr>
        <td width="3%" >&nbsp;</td>
        <td colspan="2"><div align="center" class="paratext">Update Adddons Confirm </div></td>
        </tr>
      <tr>
        <td height="17">&nbsp;</td>
      ...
      <tr>
        ...
        <td class="H1Text"><span class="Partext1"><? echo $_POST['txtpaymentmode']; ?>
		  ...
		  <input type="hidden" name="payment_type" value="<? echo $_POST['txtpaymentmode']; ?>" />
        </span></td>
      </tr>
      <tr>
        <td >&nbsp;</td>
      ...
      <tr>
        <td >&nbsp;</td>
        <td class="Partext1">Astro Match Plan : </td>
      ...
      <tr>
        ...
        <td class="H1Text"><span class="Partext1"><? echo 'MYR.'.$_POST['txtplanamount']; ?>
	  ...
	  <?php if(isset($_POST['profile_spotlight']) and $_POST['profile_spotlight'] == '1')
	  { ?>
	     <tr>
        <td >&nbsp;</td>
        <td class="Partext1">Profile Spotlight : </td>
        <td class="H1Text"><span class="Partext1"><? echo 'MYR.'.$_POST['spot_light_amount'].' for '.$_POST['spot_light_duration'].' Days'; ?>
          <input type="hidden" name="txtp11" value="<? echo $_POST['spot_light_amount']; ?>" />
		  <input type="hidden" name="txtp12" value="<? echo $_POST['spot_light_duration']; ?>" />
        </span></td>
      </tr> <?php 
	  } ?>
