            ...
            <td colspan="4" valign="top" class="HeadText1"><p>&nbsp;</p>
              ...
              <table width="75%" height="203" border="0" align="center" cellpadding="2" cellspacing="0" class="blackbox" id="content">
                ...
                <tr>
                  ...
                  <td valign="top"><a href="remove_Active_mem.php" class="Lightblue">Remove Active Members </a></td>

                  <td colspan="2" valign="top"><span class="H1Text">Database</span></td>
                ...
                <tr>
                  ...
                  <td valign="top" class="H1Text"><img src="images/icon12.gif" width="19" height="16" /></td>

                  <td valign="top" class="H1Text"><a href="dbchk.php" class="Lightblue">Database CheckUp</a></td>
