...
<table width="400" height="400" border="0" cellpadding="0" cellspacing="0" class="GreenBox">
  <tr>
    <td>
	<form action="approve_paid_form_confirm_submit.php" method="post">
	
	<table width="100%" height="400" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
	
      <tr>
        <td width="3%" >&nbsp;</td>
        <td colspan="2"><div align="center" class="paratext">Approve Active to Paid Membership Confirm </div></td>
        </tr>
      <tr>
        <td height="17">&nbsp;</td>
	  ...
	  <tr>
        ...
        <td class="H1Text"><span class="Partext1"><? echo $_POST['astromatch']; ?>
          <input type="hidden" name="astromatch" value="<? echo $_POST['astromatch']; ?>" />
        </span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td class="H1Text"><span class="Partext1"><? echo $_POST['sms']; ?>
          <input type="hidden" name="sms" value="<? echo $_POST['sms']; ?>" />
        </span></td>
      </tr>
