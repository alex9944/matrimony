...
$strname = $_GET['name'];
	...
	// DELETE PHOTO1 FILE
	$myFile = "../memphoto3/".$strphoto1;
	unlink($myFile);
	
	
	// UPDATE PHOTO1 STATUS from Yes to No
	$update1 = mysql_query("update register set Photo3 = 'nophoto.gif',Photo3Approve='No' where MatriID = '$strid'")
...
$subject = "Your $sitename photo3 has been unapproved or Deleted.";
$message = "
		<html>
<style type=text/css>
<!--
