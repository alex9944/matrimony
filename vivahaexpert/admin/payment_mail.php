...
$content.="<div id=\"page\"  style=\"border:1px solid #A50050;background:#FFF5EB;\">
  ...
  <div id=\"content\">
	...
	<p>
      ...
      Payment Type: ".$row['payment_type']."    </p>
      ...
      <tr class=\"odd\"><td bgcolor=\"#FFE5CA\">".$row['matriid']."</td>
	    ...
	    <td bgcolor=\"#FFE5CA\">";
				  ...
				  if($row['astro_match'] == 1) {
				   $content.= "Astromatch 1 Year - 1"."<br>";
				  } elseif($row['astro_3months'] == 1) {
				  $content.= "Astromatch 3 months - 1"."<br>";
				  }elseif($row['astro_6month'] == 1) {
				  $content.= "Astromatch 6 months - 1"."<br>";
				  }
    ...
    <hr>
    <p>
      Thank you for your order!  This transaction will appear on your billing statement as \"$sitename \".<br />
      If you have any questions, please feel free to contact us at <a href=\"mailto:$siteadmin\">$siteadmin</a>.    </p>

    <hr>
	
	<p>Please <a href='$site_url/contactus.php'>Contact Customer Support/Feedback</a> section of $sitename</p>
...
// Additional headers
//$headers .= 'To: rajasekaran@i-netsolution.com' . "\r\n";
