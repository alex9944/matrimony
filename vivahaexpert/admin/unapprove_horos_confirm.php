                  ...
                  <form name="form1" id="form1" method="post" action="login_submit.php" onsubmit="return memloginvalidate()">
                    ...
                    <td><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td colspan="3" class="smalltextgrey"><div align="center"><strong>Horoscope UnApproved/Deleted Confirm </strong></div></td>
                        ...
                        <tr>
                          ...
                          <td width="464" class="HeadText1"><div align="center" class="smalltextred">&quot;Member's Horoscope has been UnApprove or Deleted Success. <br />
