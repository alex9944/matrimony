...
<div id="wrapper"> 
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="5" class="tbl_profiledetails">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="607"><input type="text" name="to" value=""></td>
                </tr>
 ...
 <tr>
                  ...
                  <td width="607"><textarea id="textarea1" name="test1" style="height: 350px; width: 600px;">
        ...
        <tr>
          <td class="emailhline3" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="left" valign="middle" class="sgreen"><b> </b></td>
              </tr>
            </table><br/></td>
        </tr>
...
<font class="smallclass">This is a $sitename notification. Please do not reply to this email. This mail was created by automation.
This email was sent to you because you have agreed to receive emails from us. If you wish to stop receiving them send an email with any subject and text to <a href="mailto:$siteadmin" class="emaila">$siteadmin</a></font>
      </table></td>
  </tr>
</table>
</body>
