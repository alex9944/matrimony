...
(/** @lends <global> */function($, window, document, undefined) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Record(s) not available.",
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"full_numbers": {
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				$('.clsPageContent').html("<label class='clsPageInfo'>Page</label> <label class='clsPageStart'>"+iStartButton+"</label><label class='clsPageDivider'>/</label><label class='clsPageEnd'>"+iEndButton+"</label>");
			}
		}
	} );
