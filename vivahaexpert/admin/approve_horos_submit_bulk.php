...

{
			...
			header('location:approve_horos.php?Action=notcheck');
	...
	$update1 = mysql_query("update register set HorosApprove='Yes' where MatriID IN ('$val')")
                  ...
                  <form name="form1" id="form1" method="post" action="login_submit.php" onsubmit="return memloginvalidate()">
                    ...
                    <td><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td width="464" class="HeadText1"><div align="center" class="smalltextred">Horoscope(s) approved Successful. </div></td>
                        ...
                        <tr>
						 ...
						 // echo "$val";
						  ...
						  echo " <img src=images/redt.gif width=14 height=11 /> <a href=viewprofile.php?ID=$val> $val's Horos photos <a>- Approved Success <br><hr> ";
