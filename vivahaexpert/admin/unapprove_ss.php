...
{ 
    ...
    { 
        ...
        { 
            ...
            document.forms[0].action="unapprove_ss_to_del_submit.php?recsno="+checkboxes 
          ...
          <tr>
            ...
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">UnApprove(Delete) Success Stories</td>
              ...
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><div align="center" class="smalltextgrey">
                    ...
                    <div align="left" class="smalltextred"> Below is the list of all InActive success stories waiting Unapproval. You can click on the  ID to view the success story details.You can   convert the un approval   by clicking unapprove link </div>
...
?>
              ...
              <table width="600" border="0" align="center" cellpadding="2" cellspacing="0" class="blackbox">
                ...
                <tr>
                  ...
                  <td colspan="2" align="center" bgcolor="#ECECEC"><div align="right"></div></td>
                ...
                <tr>
                  ...
                  <td width="104"><strong> View </strong></td>

                  <td><strong>Success Story </strong></td>
          ...
          ?>
                ...
                <tr>
                  ...
                  <td><input name="<? echo $row['ID']; ?>" type="checkbox" class="check" /></td>

                  <td><? echo $row['ID']; ?></td>

                  <td><a href="#" onclick="MM_openBrWindow('viewss.php?id=<?php echo $row['ID'] ?>','ss','scrollbars=yes,resizable=yes,width=450,height=500')">View</a></td>
