...
$strname = $_GET['name'];
	...
	// DELETE PHOTO1 FILE
	$myFile = "../memphoto4/".$strphoto1;
	unlink($myFile);
	
	
	// UPDATE PHOTO1 STATUS from Yes to No
	$update1 = mysql_query("update register set Photo4 = 'nophoto.gif',Photo4Approve='No' where MatriID = '$strid'")
...
$subject = "Your $sitename photo4 has been unapproved or Deleted.";
$message = "
		<html>
<style type=text/css>
<!--
