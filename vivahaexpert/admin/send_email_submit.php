	...
	$strbody = $_SESSION['body'];
	  ...
	  //  $sql="delete from successstory where ID='$id'"; 
	   ...
	   // $result=mysql_query($sql);
	  	 ...
	  	 $sql = "SELECT * FROM register,siteconfig where MatriID  = '$id' ";
...
<p>$strbody </p>
		...
		<p style='font:normal 10px Arial, MS Sans serif, tahoma;color:#000000;'>You are receiving this mail as a registered member of $sitename. This is a computer auto generated message. Please do not Reply . </p></td>
