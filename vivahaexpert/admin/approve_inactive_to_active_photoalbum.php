...

{
			...
			header('location:active_photo_album.php?Action=not check');
	...
	$update1 = mysql_query("update photoalbum set status='Active' where pid IN ('$val')")
                  ...
                  <form name="form1" id="form1" method="post" action="login_submit.php" onsubmit="return memloginvalidate()">
                    ...
                    <td><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td width="464" class="HeadText1"><div align="center" class="smalltextred">Album photo approved successfully.</div></td>
