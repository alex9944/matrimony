...
$sql = mysql_query("SELECT * FROM register WHERE Photo3 <> 'nophoto.gif' and Photo3Approve='No' LIMIT $from, $max_results "); 
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="inner">
      ...
      <tr>
		...
		<form action="approve_photo3_submit_bulk.php" method="post" name="form1" id="form1" onSubmit="return approvevalidate()">
          ...
          <tr>
            ...
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">APPROVE MEMBERS PHOTO 3 <span class="paratext">(Waiting for Approval)</span> </td>
              ...
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><div align="center" class="smalltextgrey">
                    ...
                    <div align="left" class="smalltextred"> Below is the list of all Members Photo2 waiting approval .You can click on the profile ID to view the Photo.You can   approve/disapprove  by clicking the link. </div>
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register WHERE Photo3 <> 'nophoto.gif' and Photo3Approve='No'"),0); 
...
?>
              ...
              <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0">
                ...
                <TR bgcolor="#FFFFFF" onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';">
                  ...
                  <td class="smalltextgrey"><?php echo $row['Photo3Approve']?></td>
				 ...
				 <!-- <img src="../photoprocess.php?image=memphoto3/<?php  echo $row['Photo3']?>&maxim_size=100;" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto3.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	-->		

				 

				 <img src="../memphoto3/<?php echo $row['Photo3']?>" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto3.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">			  
                  ...
                  <td class="smalltextgrey"><a href="Approve_photo3_submit.php?ID=<?php echo $row['MatriID']?>&amp;Action=approve">Approve Photo </a></td>

                  <td class="smalltextgrey"><a href="UnApprove_photo3_submit.php?ID=<?php echo $row['MatriID']?>&amp;delphoto=<?php echo $row['Photo1']?>&amp;Action=unapprove&email=<?php echo $row['ConfirmEmail']?>&name=<?php echo $row['Name']?>">Disapprove Photo </a></td>
