...
<div class="profile_block">
  <div class="header">
    <h3 class="float_left title">View Protected Photo Album</h3>
  </div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="content">
            <tr>
              <td align="left">The Photo Album has been protected by the owner of this profile. Members are given the feature to protect their Phone from viewing by anyone. If the Phone is protected, then you need a Phone Password to view it. <br>
                <br>
                Contact the profile and make a request for the Photo Album Password.<br>
                <br>
                <strong>If you have already obtained the Photo Album Password then enter the Password below and click on the 'View' button.</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><div align="center">
                  <form action="viewprotectalbumform_submit.php" method="post">
                    <table width="374" border="0" cellpadding="2" cellspacing="2" class="tbl_profiledetails" align="center">
                      <tr>
                        <td height="19" colspan="2"><strong>View Photo Album <em>
            ...
            <tr>
              <td><div align="center">Note : <strong class="Alert">If you have not password <a href="albumpasswordrequest.php?MatriID=<? echo $strmatriid; ?>">click here</a> to Request Album Password.</strong></div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
