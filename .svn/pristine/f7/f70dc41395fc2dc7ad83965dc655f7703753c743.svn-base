...
<div id="wrapper"> 
          ...
          <form action="edit_par.php" method="post" name="MatriForm" id="MatriForm" onSubmit="return Validate()">
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="tbl_profiledetails">
              <tr class="hline2">
                ...
                <td><div align="left">: &nbsp; 
				<?php
				$looking= array('Unmarried','Widow/Widower','Divorcee','Separated');
				 ?>
  ...
  "ZW" => "Zimbabwe"
              ...
              <tr class="hline2">
                ...
                <td><div align="left">: &nbsp; 
					<?php $height= array('Does not Matter','Below 4ft',"4-6","4-7","4-8",'4-9','4-10','4-11','5-0','5-1','5-2','5-3','5-4','5-5','5-6','5-7','5-8','5-9','5-10','5-11','6-0','6-1','6-2','6-3','6-4','6-5','6-6','6-7','6-8','6-9','6-10','6-11','7-0','Above 7ft') ?>
              ...
              <tr class="hline2">
				...
				<?php $caste =array('Hindu', 'Christian', 'Muslim', 'Sikh','Jain','Parsi','Buddhist','Bahai','Inter-Religion','Others');
			 ?>
				<select name="religion" id="religion" onChange="return caste_disable(document.MatriForm.religion);" style="width:200px;" onchange="caste()">
                    <option value="---">- Select -</option>
					<?php
						foreach ($caste as $castes) {
						 if ($row['PE_Religion']==$castes) { ?>
              ...
              <tr class="hline2">
                ...
                <td><div align="left">: &nbsp; <select id= "caste" name="caste[]" multiple="multiple" size="10" id="caste" style="width:200px;">
