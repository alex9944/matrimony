...
<div class="profile_block">
  <div class="header">
    <h3 class="float_left title">View Protected Video</h3>
  </div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="content">
            ...
            <tr>
              <td><div align="center">
                  <form action="viewprotectvideoform_submit.php" method="post">
                    <table width="374" border="0" cellpadding="2" cellspacing="2" class="tbl_profiledetails" align="center">
                      <tr>
                        <td height="19" colspan="2"><strong>View Video <em>
            ...
            <tr>
              <td><div align="center">Note : <strong class="Alert">If you have not password <a href="videopasswordrequest.php?MatriID=<? echo $strmatriid; ?>">click here</a> to Request Video Password.</strong></div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
