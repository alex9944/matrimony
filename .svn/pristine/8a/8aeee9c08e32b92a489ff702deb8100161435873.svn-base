...
$searchquery = "SELECT R.*,V.* FROM photo_request V,register R WHERE V.sender  = '".$_SESSION['matriid']."' $keystatus AND V.receiver = R.MatriID and V.type = 'photo_password' "; 

//echo $searchquery = "SELECT R.*,V.* FROM photo_request_status V,register R WHERE V.sender_id  = '".$_SESSION['matriid']."' AND V.receiver_id = R.MatriID"; 
...
<span class="pathway"> <?Php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Photo Password Request Sent</span>
</div>
        </li>
...
<form action="" method="post" name="searchrsforms" id="searchrsforms">
 ...
 <!-- BUSINESS PAGE CONTENT STARTS HERE ############################################ -->   
    <a name="top" id="top"></a>
      ...
      <h1>Photo Password Request Sent</h1>
...
?>
			 ...
			 <?php 
			$photostatus  = '';
			$recid        = $searchresultfetch['MatriID'];
			$sender_id    = $_SESSION['matriid'];
			...
			<div style="float:left; margin:7px; text-transform:capitalize;"><b style="color:#A50050;">Current Status :</b> <?php echo ucwords($photo_status); ?></div>
