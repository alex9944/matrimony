                              ...
                              <tr>
                                <td align="left" valign="top" ><form action="manageuser.php?delid=<?php echo $view_fetch['p_id'];?>" method="post" enctype="multipart/form-data" name="postForm" id="form1" onsubmit="return postCheck();">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
                                      <tr>
                                        <td colspan="3" align="right" class="bold"><a href="manageclassified.php" class="ad_text_color">Back</a></td>
                                      </tr>
                                      <tr>
...
return false;" /></td> -->
    <td width="33%" class="bold"><?PHP
        ...
        <?php } if($activate==0){?>
        <a href="manageclassified.php?actid=<?Php echo $userid_admin;?>" class="ad_text_color" onclick="if(confirm('Are you sure you want to InActivate this Record?') )
								{
								 return true;
								}
								else
