...

{
 ...
 $delete = mysql_query("delete from successstory where id=".$_POST['chkapprove'][0])

 or die("Could not update data because ".mysql_error());
 
 header('location:approve_ss.php');
                ...
                <tr>
                    ...
                    <td><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td colspan="3" class="smalltextgrey"><div align="center"><strong> <? if(!isset($_POST['delete'])) { ?>SUCCESS STORY APPROVE CONFIRMATION <? } ?> </strong></div></td>
                        ...
                        <tr>
                          ...
                          <td width="464" class="HeadText1"><div align="center" class="smalltextred">
						 <? if(!isset($_POST['delete'])) { ?>
						  Success stories  approved successful.
						  <? } else { ?>
						  Success stories  deleted successfuly.
						<?  } ?>
						  </div></td>
