...
header("location:manageclassified.php");
               ...
               <select name="subcategory" class="combo_box">
				...
				<?php } ?>
				  ...
				  <tr>
                    ...
                    <td align="center" class="bold"><strong>:</strong></td>
                    <td><input name="state1" type="text" id="state1" class="text_box" value="<?php echo $detail1['p_state'];?>" /></td>
                  </tr>
                  <tr>
			  ...
			  <option value="<?php echo $state12['stateid'];?>"<?php if($state12['stateid']==$detail1['p_state']) { ?> selected="selected"<?php } ?> ><?php echo $state12['state_name'];?></option><?php }?>
                 ...
                 <!-- <tr>
                  ...
                  <tr>
					...
					<tr><td align="right" colspan="4"><span class="ad_text_color"><a href="manageclassified.php" class="link1">Back </a></span></td>
					</tr>
                </table>
