				...
				<?php } ?>
				 ...
				 <tr>
                   ...
                   <tr>
						...
						<td align="center" class="bold">:</td>
                       <td><select name="country" class="combo_box" onchange="Javascript:categorylisted(this.value);">
				...
				<tr>
                  ...
                  <td><!--<label>
					...
					<div id="statenew">
							...
							<?php  $states=mysql_query("select * from class_state order by state_name asc");
							 while($stat=mysql_fetch_array($states)) {?>
							<option value="<?php echo $stat['stateid'];?>" <?php if($detail1['p_state'] == $stat['stateid']) echo "selected";?> ><?php echo $stat['state_name'];?></option>
							<?php } ?>
							</select>
						</div>
             ...
             <?php /*    <tr>
			  ...
			  <option value="<?php echo $state12['stateid'];?>"<?php if($state12['stateid']==$detail1['p_state']) { ?> selected="selected"<?php } ?> ><?php echo $state12['state_name'];?></option><?php }?>
                ...
                <!--  <tr>
                  ...
                  <tr>
                    <td colspan="3" align="center">
						<input name="edit_form" type="submit" class="but_bg" value="Update Classified " <?php if(isset($_SESSION['dlogin'])) { ?> disabled="disabled" <?php } ?> />&nbsp;&nbsp;&nbsp;
