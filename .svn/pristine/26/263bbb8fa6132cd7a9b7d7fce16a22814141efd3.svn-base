...
$searchquery = "SELECT r.*, pd.matriid, pd.spot_light FROM register r LEFT JOIN payment_details pd ON pd.matriid = r.MatriID WHERE Star != "."'".$fetch['Star']."'   AND Religion = "."'".$fetch['Religion']."' AND Caste ="."'".$fetch[
