    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <div class="header">
          ...
          <h3 class="float_left title">Video View Request </h3>
            ...
            <tr>
              ...
              <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    ...
                    <td><form name="eiform" id="eiform" action="video_protect_int_send_submit.php"  method="post">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td colspan="2" valign="center" bgcolor="#FFFFFF"><strong>Video View Request  : <?php echo $streiid ?></span>
                            ...
                            <tr>
                              ...
                              <td valign="center">I am interested in your profile. Please enable your video. </td>
                            </tr>
