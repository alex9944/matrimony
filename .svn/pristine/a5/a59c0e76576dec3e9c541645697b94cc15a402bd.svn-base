...
<tr>
  ...
  <td valign=top class=style3>$MatriID has sent you an Interest. To respond, kindly visit <a href='$site_url/express_received_pendinglist.php'>$site_url/express_received_pendinglist.php</a></td>
              ...
              <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    <td><table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" >
                        <tr>
                          <td align="center"><b>You have successfully expressed interest to <? echo $streiid ?></b></td>
                        </tr>
						
						<tr><td style="text-align:center; float:left; margin-left:300px;"><a style="float:right; clear:right; margin:5px 0px;" class="button-small square-orange uppercase float_right" href="id_search_submit.php?txtID=<?php echo $_REQUEST['eiid']; ?>"><span></span> Back </a></td></tr>
