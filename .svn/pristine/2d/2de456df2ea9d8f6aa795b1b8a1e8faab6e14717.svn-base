...
if(isset($_POST['Submit']))
{
	...
	if($newpassword==$newcpassword) {
		...
		if($dbpassword != $newcpassword && $dbpassword == $oldpassword) {
			...
			$to=$row['reg_email'];
			$subject="Change password Information - clickone.com";
			...
			<br/><br/>Thanks for clickone.com Classfied!
			<br/> - $site_team
			</td>
			</tr>
			</table>
...
?></td>
                         ...
                         <tr>
                           <td align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                               <tr>
                                 <td align="center" valign="top" height="30"><input name="Submit" type="submit" class="but_bg" value="Submit" /></td>
                               </tr>
                           </table></td>
                         </tr>
                       </table>
