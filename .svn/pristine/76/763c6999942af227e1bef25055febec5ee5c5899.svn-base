...
$subject = "video view Request";
$body = 'I am interested in your profile. Please enable your video.';
...
$exe_insert = mysql_query($insert );
		...
		print "<script>";
		print " self.location='video_success_confirm.php?eiid=$streiid';"; // Comment this line if you don't want to redirect
		print "</script>";
