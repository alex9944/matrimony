...
$sql = "SELECT * FROM register WHERE (Photo7 != '0' and Photo7 != '') and (Photo7Approve='No' or Photo7Approve='0' ) LIMIT $from, $max_results ";
$sql = mysql_query($sql); 
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="inner">
      ...
      <tr>
		...
		<form action="approve_photo7_submit_bulk.php" method="post" name="form1" id="form1" onSubmit="return approvevalidate()">
          ...
          <tr>
            ...
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">APPROVE MEMBERS PHOTO 7 <span class="paratext">(Waiting for Approval)</span> </td>
...
$sql  = "SELECT * FROM register WHERE (Photo7 != '0' and Photo7 != '') and (Photo7Approve='No' or Photo7Approve='0' )";
...
?>
              ...
              <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0">
                ...
                <tr>
				 ...
				 $sql = "SELECT * FROM register WHERE Photo7 <> 'nophoto.gif' and Photo7Approve='No' order by ID desc LIMIT $from, $max_results  ";
				...
				/* while($row = mysql_fetch_array($result))
				 ...
				 //$sql = mysql_query("SELECT * FROM register WHERE (Photo7 != '0' and Photo7 != '') and (Photo7Approve='No' or Photo7Approve='0' ) LIMIT $from, $max_results order by ID desc ");
				 while($row = mysql_fetch_array($result))
				 { ?>
                ...
                <TR bgcolor="#FFFFFF" onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';">
                  ...
                  <td class="smalltextgrey"><?php echo $row['Photo7Approve']?></td>
				...
				<!--  <img src="../photoprocess.php?image=memPhoto6/<?php echo $row['Photo7']?>&maxim_size=100" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewPhoto6.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	-->

				  

				   <img src="../memphoto7/<?php echo $row['Photo7']?>" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewPhoto7.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	
                  ...
                  <td class="smalltextgrey"><a href="Approve_Photo7_submit.php?ID=<?php echo $row['MatriID']?>&amp;Action=approve">Approve Photo </a></td>

                  <td class="smalltextgrey"><a href="UnApprove_Photo7_submit.php?ID=<?php echo $row['MatriID']?>&amp;delphoto=<?php echo $row['Photo7']?>&amp;Action=unapprove&email=<?php echo $row['ConfirmEmail']?>&name=<?php echo $row['Name']?>">Disapprove Photo </a></td>
