...
include('dbconnect.php');
			...
			$strreceiver = $_GET['MatriID'];
			$getgendersql = mysql_query("SELECT Gender FROM register WHERE MatriID = '".$strreceiver."'");
			$getgenderfetch = mysql_fetch_array($getgendersql);
$streigen = $getgenderfetch['Gender'];
