...
?>
              ...
              <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0">
				...
				<!--  <img src="../photoprocess.php?image=memphoto1/<?php echo $row['Photo1']?>&maxim_size=100" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto1.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	-->

				  

				   <img src="../memphoto1/<?php echo $row['Photo1']?>" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto1.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	
                  ...
                  <td class="smalltextgrey"><a href="UnApprove_photo1_submit.php?ID=<?php echo $row['MatriID']?>&amp;delphoto=<?php echo $row['Photo1']?>&amp;Action=unapprove&email=<?php echo $row['ConfirmEmail']?>&name=<?php echo $row['Name']?>">Disapprove Photo </a></td>
