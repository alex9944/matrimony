...
$sql  = mysql_query("insert into phone_request_status (sender_id, receiver_id, status, created_date, updated_date, type) values ('$strtoid', '$strsenderid', '$status', '$ctime', '$ctime', 'photo_password')");

$subject = "Photo Password Request";
$body = 'I am interested in   your profile. Please send your photo password.';

$insert = "INSERT INTO `photo_request` ( `receiver`, `sender`, `subject`, `message`, `date_sent`, `status`, `type`, `updated_date`) VALUES ('$strsenderid', '$strtoid', '$subject', '$body', now(), 'pending', 'photo_password', '$ctime');"; 
...
<div class="profile_block">
  ...
  <div class="body" align="left">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><form action="photopass_send_request_submit.php" method="post" name="form">
