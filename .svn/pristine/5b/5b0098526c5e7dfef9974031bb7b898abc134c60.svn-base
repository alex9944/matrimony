...

{
	...
	window.location.href = 'edusearch_results.php?page='+pageno+linktext;
...
$link = "&txtGender=".$_REQUEST['txtGender']."&txtSAge=".$_REQUEST['txtSAge']."&txtEAge=".$_REQUEST['txtEAge']."&txtEdu=".$_REQUEST['txtEdu']."&religion=".$_REQUEST['religion']."&caste=".$_REQUEST['caste']."&Country=".$Country."&State=".$State."&txtphoto=".$_REQUEST['txtphoto'];
