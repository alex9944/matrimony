...
<?Php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Privacy Policy</span>
    ...
    <div id="inner_right">
      ...
      <div class="profile_block">
        ...
        <div class="header">
          ...
          <span class="black" style="color:#C8060E;">Privacy Policy</span></h2>

        </div>

        <div class="body">

              <?php $privacy=mysql_fetch_array(mysql_query("select privacy from cms_contents where id='1'"));
