...
while($row = mysql_fetch_array($result))

  {
	...
	if($status == 'accept')
	 {
	    $photostatus  =  "<p>Heres your horoscope request has been approved</p>";
	 }
	else
	 {
	    $photostatus  =  "<p>Heres your horoscope request has been declined.</p>";
	 } 
	
	$subject = "Your horoscope request status : $status on $sitename";
	...
	<td valign=top class=style3><p>Thank you for requesting member's horoscope.</p>
	...
	$headers .= 'From: '.ucfirst($sitename).' <'.$siteadmin.'>'."\r\n";
			...
			$db_message = "<p>Thank you for requesting member\'s horoscope.</p>
			<p>$sitename, the Most Successful Matrimony Portal for Indians.</p>
			$photostatus ";
...
//$sql  = "insert into horoscope_request (sender_id, receiver_id, status, created_date) values ('$strtoid', '$strsenderid', '$status', '$ctime')";
$sql  = "update horoscope_request_status set status = '$status', updated_date = '$ctime' where sender_id = '$strtoid' and receiver_id = '$strsenderid' ";
$sql  = mysql_query($sql);

$sql  = "update horoscope_request set status = '$status', updated_date = '$ctime' where sender  = '$strtoid' and receiver  = '$strsenderid' ";
$sql  = mysql_query($sql);
...
<div class="profile_block">
  <div class="header">
    <h3 class="float_left title">Horoscope Request</h3>
  </div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <td><div align="center">Your Horoscope Request Status has been sent to this Member <?php echo $strtoid; ?> successfully. </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
