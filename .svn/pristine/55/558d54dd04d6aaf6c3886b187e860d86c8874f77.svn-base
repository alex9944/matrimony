...
$update1 = mysql_query("update register set album_protect ='Yes', album_password ='".$_POST['ppwd']."' WHERE MatriID='".$_SESSION['username']."' OR ConfirmEmail = '".$_SESSION['username']."'");
?>
            ...
            <tr>
              <td><div align="center">
                  <table width="374" border="0" cellpadding="2" cellspacing="2" class="tbl_profiledetails">
                    <tr>
                      <td width="312" height="19"><div align="center">Phone Album has been Protected Successfully. </div></td>
                    </tr>
                  </table>
                </div></td>
            </tr>
