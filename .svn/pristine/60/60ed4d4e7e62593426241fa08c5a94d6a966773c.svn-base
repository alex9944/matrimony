...
header("location:index.php");
	...
	{
		$cid=$_REQUEST['cid'];
		$select="select * from class_category order by c_name $cid";
	}
	else
	{
		$select="select * from class_category order by c_name asc";
	}	
	$strget="c_id=$cid";
              $rowsPerPage =15;
	...
	if(isset($_REQUEST['id']))
	{
		...
		$filename = "../images/category_icon/".$cid.'.'.$_GET['ext'];
		if (file_exists($filename)) {
    		unlink($filename);
		}
		mysql_query("delete from class_category where c_id='$cid'");
		mysql_query("delete from class_subcategory where cid='$cid'");
...
window.location.href="changecategory.php?cid="+document.cate.ddlcategory.options[document.cate.ddlcategory.selectedIndex].value;
}
function editfun()
{
	...
	<tr>
		<td height="223" colspan="2">
			...
			<table width="77%" align="center" cellspacing="0" style="border:solid 1px #0F507F;">
				<tr bgcolor="#669966">
				  <td height="34" colspan="3" align="left" bgcolor="#edcfde"><span class="link1">Category Management </span></td>
			  </tr>
				<tr>
				  <td height="34" colspan="2" align="left" bgcolor="#faf3f7"><span class="link1"><a href="addcategory.php">Add a new category</a></span></td>
				  <td width="74%" height="34" align="left" bgcolor="#faf3f7"><select class="combo_box" name="ddlcategory" onchange="javascript:category11();">
				...
				<tr>
				  <td colspan="3" bgcolor="#faf3f7"><table width="90%" height="79" align="center" cellspacing="0" style="border:1px solid #edcfde;">
					  ...
					  <td width="230" height="29" align="center" bgcolor="#edcfde"><strong>CategoryName</strong></td>
					  <td width="72" align="center"><strong>Subcategory</strong></td>
					  <td width="72" align="center"><strong>Edit</strong></td>
					  <td width="62" align="center"><strong>Delete</strong></td>
					  </tr>
						<?php 
						while($category=mysql_fetch_array($query)){
						$cid=$category['c_id'];
						?>
						<tr class="link1"><td>&nbsp;&nbsp;<a href="changesubcategory.php?catid=<?PHP echo $cid;?>" class="greenli"><?PHP echo $category['c_name'];?></a></td>
						<td><a href="changesubcategory.php?catid=<?PHP echo $cid;?>" class="bluebold">Subcategory</a></td>
						<td align="center"><a href="editcategory.php?catid=<?PHP echo $cid;?>"><img src="images/edit_f2.png" width="32" height="32" border="0" title="Edit" /></a></td>
						
						<td align="center"><a href="changecategory.php?id=<?php echo $category['c_id'];?>&ext=<?php echo $category['c_filetype'];?>" onclick="return confirm('Are you sure you wish to delete this Record?');"> <!-- <a href="javascript:void(0);" class='boldG2' onclick="javascript:alert('This Feature Is Disabled In The Demo Version.. ');return false;"> --><img src="images/delete.jpg" border="0" title="Delete" /></a></td>
						</tr>
					<?php }?>
						<tr><td colspan="4" align="center">&nbsp;</td></tr>						
						<?php if($num<=0){?>
						<tr><td colspan="4" align="center"><span class="style1">No Categories Found</span></td>
						</tr>
						<?php }?>
