...
<div style="text-align: center; display:none;" id="medium_box">
		<!-- Beginning of meebo me widget code. Want to talk with visitors on your page? Go to http://www.meebome.com/ and get your widget! --> <script type="text/javascript">
AC_AX_RunContent( 'width','250','height','300','src','http://widget.meebo.com/mm.swf?DzqjiMWZiC','type','application/x-shockwave-flash','movie','http://widget.meebo.com/mm.swf?DzqjiMWZiC' ); //end AC code
</script><noscript><object width="250" height="300" ><param name="movie" value="http://widget.meebo.com/mm.swf?DzqjiMWZiC"/><embed src="http://widget.meebo.com/mm.swf?DzqjiMWZiC" type="application/x-shockwave-flash" width="395" height="275"></embed></object></noscript>
			</div>
    <div id="title">
