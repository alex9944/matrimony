...
<div id="container">
  ...
  <tr>
	...
	<th width="8%" align="center" class="tab_head">View </th>
...
?>
  <tr >
	...
	<td align="center" class="tab1"><span class="ad_text_color"><a href="view_classified.php?p_id=<?php echo $seldata['p_id'] ?>"> <img src="admin/images/view_icon.jpg" width="25" height="20" border="0" title="View"/> </a></span></td>
	
    <td align="center" class="tab1"><span class="ad_text_color"><a href="edit_classified.php?p_id=<?php echo $seldata['p_id'] ?>"> <img src="admin/images/edit_f2.png" width="25" height="20" border="0" title="Edit"/> </a></span></td>
    
    <td align="center" class="tab1"> 
	<?php if(!isset($_SESSION['dlogin'])) { ?>
	<a href="javascript:if(confirm('Are you Sure Want To Delete')){ window.location='edit_class.php?p_id=<?php echo $seldata['p_id'] ?>';}"> <?php } elseif(isset($_SESSION['dlogin'])) { ?> <a href="javascript:void(0);'" onclick="javascript:alert('This is Demo version only');"> <?php } ?>
	
	<img src="images/delete_x.jpg" border="0" /></a></td>
  </tr>
  <?php
