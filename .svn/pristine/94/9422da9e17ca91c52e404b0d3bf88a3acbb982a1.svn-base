...
<div id="page" style="background:#FFF5EB">
  ...
  <div style="text-align:center;"><b>INVOICE CUM RECEIPT</b></div>
  <div id="content">
    <p>
    ...
    <hr>
    <p>
      Thank you for your order!  This transaction will appear on your billing statement as <?=$siteadmin; ?> .<br />
    ...
    <p>
      <center><small><br />
     copyright &copy; <?php echo $sitename; ?> - All Rights Reserved
      </small>
      </center>
    </p>
  </div><!--end content-->
