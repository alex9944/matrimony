...
header("location:index.php");
	...
	if($_REQUEST['cid']!="")
	{
		...
		$cateid=$_REQUEST['catid'];
		$cid=$_REQUEST['cid'];
		$select="select * from class_state where countryid='$cateid' order by state_name $cid";
	}
	else
	{
	$select="select * from class_state where countryid='$cateid' order by state_name asc";
	}
	...
	$cateid=$_REQUEST['catid'];
	  ...
	  mysql_query("delete from class_state where stateid='$delid'");
	  mysql_query("delete from class_city where stateid='$delid'");
	  header("location:changestate.php?catid=$cateid");
	}
?>
...
window.location.href="changestate.php?cid="+document.subcat.ddlcategory.options[document.subcat.ddlcategory.selectedIndex].value +"&catid="+<?php echo $cateid;?>
}
function editfun()
{
	...
	<tr>
		<td height="223" colspan="2">
			...
			<table width="77%" align="center" cellspacing="0" style="border:solid 1px #edcfde;">
				<tr bgcolor="#edcfde">
				  <td height="34" align="left" bgcolor="#edcfde"><span class="link1">State Management&nbsp;&nbsp;&nbsp;&gt;&gt;</span></td>
			      <td height="34" align="left" bgcolor="#edcfde"><span class="link1"><?php echo $rowcat['country']; ?></span></td>
			      <td align="left" bgcolor="#edcfde">&nbsp;</td>
			      <td align="left" bgcolor="#edcfde">&nbsp;</td>
			      <td align="right" bgcolor="#edcfde" class="ad_text_color"><a href="changecountry.php">Back</a></td>
			  </tr>
				<tr>
				  <td width="24%" height="34" align="left" bgcolor="#faf3f7"><span class="link1"><a href="addstate.php?cid=<?php echo $_REQUEST['catid']; ?>">Add a new state </a></span></td>
				...
				<tr>
				  <td colspan="5" bgcolor="#faf3f7"><table width="90%" height="79" align="center" cellspacing="0" style="border:1px solid #edcfde;">
					  ...
					  <td width="277" height="29" align="center" bgcolor="#edcfde"><strong>State Name</strong></td>
					  <td width="197" align="center"><strong>Edit</strong></td>
					  <td width="183" align="center"><strong>Delete</strong></td>
					  </tr>
						<?php 
						while($category=mysql_fetch_array($query)){
					
						?>
						<tr class="link1"><td style="padding-left:25px;">&nbsp;&nbsp;<a href="changecity.php?catid=<?PHP echo $_REQUEST['catid'];?>&sid=<?php echo $category['stateid']; ?>" class="greenli"><?PHP echo $category['state_name'];?></a></td>
						<td align="center"><a href="editstate.php?mcat=<?PHP echo $cateid;?>&scat=<?PHP echo $category['stateid'];?>"><img src="images/edit_f2.png" width="32" height="32" border="0" title="Edit" /></a></td>
						
						<td align="center"><a href="changestate.php?id=<?php echo $category['stateid'];?>&catid=<?php echo $category['countryid'];?>" onclick="return confirm('Are you sure you wish to delete this Record?');"><img src="images/delete.jpg" border="0"  title="Delete"/></a></td>
					...
					<?php }?>
						...
						<?php if($num<=0){?>
						<tr>
						  <td colspan="3" align="center"><span class="link1">No States Found</span></td>
						</tr>
						<?php }?>
