...
//END PAGING
 ...
 $searchquery = "SELECT R.*,V.*, pd.matriid, pd.spot_light FROM visitor V,register R LEFT JOIN payment_details pd ON pd.matriid = R.MatriID WHERE V.vmemberid  = '".$_SESSION['matriid']."' AND V.memberid = R.MatriID order by pd.spot_light desc, R.ID desc"; 
...
?></td>
          ...
          <tr>
			...
			loadCaste(<?php echo $searchresultfetch['Language'] ?>,<?php echo $searchresultfetch['Religion'] ?>, <?php echo $searchresultfetch['Caste'] ?>,'<?php echo $searchresultfetch['MatriID'] ?>');
			
			<?php /*?>do_request(<?php echo $searchresultfetch['Language'] ?>,<?php echo $searchresultfetch['Religion'] ?>, <?php echo $searchresultfetch['Caste'] ?>,'<?php echo $searchresultfetch['MatriID'] ?>');<?php */?>
			</script>
			...
			<?php /*?><?php echo $searchresultfetch['Caste']; ?><?php */?>
			</td>
          </tr>
          <tr>
            <th>Education</th>
