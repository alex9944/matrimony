...
$searchquery = "SELECT R.*,V.* FROM horoscope_request V,register R WHERE V.sender  = '".$_SESSION['matriid']."' $keystatus AND V.receiver = R.MatriID "; 

//echo $searchquery = "SELECT R.*,V.* FROM horoscope_request_status V,register R WHERE V.sender_id  = '".$_SESSION['matriid']."' AND V.receiver_id = R.MatriID"; 
...
<span class="pathway"> <?Php echo $breadcrumbspage; ?> <img alt="" src="images/icons/arrow_breadcrumbs.png">Horoscope Request Sent</span>
</div>
        </li>
