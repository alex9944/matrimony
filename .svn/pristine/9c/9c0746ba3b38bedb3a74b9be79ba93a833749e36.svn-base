...
if(isset($_REQUEST['addcat']))
{
	...
	mysql_query("insert into class_category (c_name, c_status) values('$category',0)") or die(mysql_error());
	...
	if($_FILES['image']['name'] != "") {
		...
		$upload3="../images/category_icon/".$getid.'.'.$file_ext;
		move_uploaded_file($tmpfilename3,$upload3);
		
		if($_FILES['image']['error'] == 0)
			mysql_query("update class_category set c_filetype = '$file_ext' where c_id='$getid'");
	}
	...
	<tr>
		<td height="223" colspan="2">
			<table width="77%" align="center" cellspacing="0" style="border:solid 1px #669966;">
				<tr>
				  <td height="27" bgcolor="#edcfde" class="link1">&nbsp;&nbsp;Add New Category </td>
				</tr>
				<tr>
				  <td align="right" bgcolor="#faf3f7">&nbsp;</td>
				</tr>
				<tr><td valign="top" bgcolor="#faf3f7">
					<form name="addcategory" enctype="multipart/form-data" method="post" onsubmit="return val();">
					<table width="400" border="0" align="center" cellspacing="5" style="border:1px solid #D8F1E4;">
					
						<tr class="normal" bgcolor="#faf3f7">
						  <td width="171" class="link1">&nbsp;&nbsp;Categroy Name</td>
						  <td width="195">
						    <input name="category" type="text" class="text_box" id="category" />
						  </td>
						</tr>
						<tr class="normal" bgcolor="#faf3f7">
						  <td width="171" class="link1">&nbsp;&nbsp;Categroy Image</td>
						  <td width="195" align="">
						    <input type="File" name="image" id="image" /><br />
							<em>width: 34px | height: 26px</em>
						  </td>
						</tr>
					
						<tr><td colspan="2" align="center" bgcolor="#faf3f7">
				<!-- demo		<input type="submit" name="addcat" value="Submit"  onclick="return editfun()"/> -->
				<input type="submit" name="addcat" class="but_bg" value="Submit"/>
