...
$str_drink = $_POST['txtDrink'];*/
 $str_habbits= implode(",",$_POST['txtHabbits']);

//echo $_SESSION['Smoke']= strip_tags($_POST['txtSmoke']);
//exit();
...
*/
$update1 = mysql_query("update register set Height ='$str_hei',Weight='$str_wei',BloodGroup='$str_blood',Complexion='$str_comp',Bodytype='$str_bt', Diet='$str_diet',txtHabbits='$str_habbits' WHERE MatriID= '$strid' ");
