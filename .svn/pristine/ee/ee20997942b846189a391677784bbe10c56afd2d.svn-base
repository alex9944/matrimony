...
//END PAGING
  ...
  $searchquery = "SELECT R.*,V.*, pd.matriid, pd.spot_light  FROM expressinterest V,register R LEFT JOIN payment_details pd ON pd.matriid = R.MatriID WHERE V.eisender  = '".$_SESSION['matriid']."' AND V.eireceiver = R.MatriID"; 
