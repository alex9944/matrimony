    ...
    <div id="inner_right"> 
      ...
      <div class="profile_block">
        ...
        <div class="header">
          ...
          <h2 class="float_left title"> <span class="black" style="color:#333;"><?php echo $sitename; ?>:</span> Unsubscribed </h2>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="1219"><div align="left">
                    ...
                    <p>You have been successfuly Unsubscribed from the site.                        <br/>
...
With warm regards from the '.$sitename.' Team<br/><br/>
