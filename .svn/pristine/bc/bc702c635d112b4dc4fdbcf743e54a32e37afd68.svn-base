...
$strname = $_GET['name'];
	...
	// DELETE PHOTO1 FILE
	$myFile = "../memphoto2/".$strphoto1;
	unlink($myFile);
	
	
	// UPDATE PHOTO1 STATUS from Yes to No
	$update1 = mysql_query("update register set Photo2 = 'nophoto.gif',Photo2Approve='No' where MatriID = '$strid'")
...
$subject = "Your $sitename photo2 has been unapproved or Deleted.";
$message = "
		<html>
<style type=text/css>
<!--
