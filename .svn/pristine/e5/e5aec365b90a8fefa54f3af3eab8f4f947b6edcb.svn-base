...
$result = mysql_query("UPDATE register set Noofcontacts = '$strno' WHERE MatriID = '$strid' ");
            ...
            <td colspan="4" valign="top" class="HeadText1"><br />
                ...
                <table width="75%" border="0" align="center" cellpadding="3" cellspacing="3" class="blackbox">
                  ...
                  <tr>
                    ...
                    <td class="Partext1"><div align="center">Reset Contact Allocation Successful. </div></td>
