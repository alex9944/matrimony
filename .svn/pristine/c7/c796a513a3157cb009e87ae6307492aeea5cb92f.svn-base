...
<body>
<?php $total_amount = 0; $slno = 0;  while($row = mysql_fetch_array($memchk)){ ?>
<table width="83%" border="0" align="center" cellpadding="5" cellspacing="1" class="blackbox">
  <tr>
    <td colspan="5"><div align="left"><img src="images/logo.png" /></div></td>
  </tr>
  <tr>
    <td colspan="5"><div align="center"><img src="pics/invoice.gif" width="122" height="31" /></div></td>
  </tr>
  <tr>
    <td width="9%" valign="top">Bill To : </td>
    <td width="43%">
      <span class="bodysg">
	  <?php  echo $row['Pmatriid']?><br />
      <?php  echo $row['Pname']?>
      <br />
      <?php  echo $row['Pemail']?>
      <br />
  ...
  <tr>
    <td height="23" bgcolor="#D5D5D5"><div align="left"><strong>S.No</strong></div></td>
 ...
 <?php
 if(isset($row['Pamount']) and $row['Pamount'] != '')
 { ?>
  <tr>
    <td bgcolor="#F5F5F5"><span class="Partext1">
      <?php echo ++$slno;  //echo $row['Paidid']?>
    </span></td>
    <td bgcolor="#F5F5F5">
      <span class="bodyp">
    <?php  echo $row['Pplan']?>
    ...
    <td bgcolor="#F5F5F5"><div align="center"><span class="Partext1">
      MYR.<?php  echo $row['Pamount']?>
    </span></div></td>
    <td bgcolor="#F5F5F5"><div align="center"><span class="Partext1">
      MYR.<?php  echo $row['Pamount']; $total_amount = $total_amount + $row['Pamount']; ?>
    </span></div></td>
  </tr> <?php
  } ?>
  
  <?php
  if(isset($row['addons']) and $row['addons'] == 'addons' and $row['profile_spotlight_amount'] != '')
   { ?>
     <tr>
    <td bgcolor="#F5F5F5"><span class="Partext1">
      <?php echo ++$slno; //echo $row['Paidid']?>
    ...
    <td bgcolor="#F5F5F5">
      <span class="bodyp">
    <?php  echo 'Profile Spot Light for ';?>
    <?php  echo $row['profile_spotlight_duration']?>
    days</span></td>
    <td bgcolor="#F5F5F5"><div align="center">1</div></td>
    <td bgcolor="#F5F5F5"><div align="center"><span class="Partext1">
      MYR.<?php  echo $row['profile_spotlight_amount']?>
    </span></div></td>
    <td bgcolor="#F5F5F5"><div align="center"><span class="Partext1">
      MYR.<?php  echo $row['profile_spotlight_amount']; $total_amount = $total_amount + $row['profile_spotlight_amount'];?>
    </span></div></td>
  </tr>
     <?php 
   }
