      ...
      <tr>
        ...
        <td width="80%"><table width="100%" height="400" border="0" cellpadding="2" cellspacing="1" id="content">
          ...
          <tr>
            ...
            <td valign="top"><a href="active_photo_album.php" class="Lightblue">Activate Photo album</a></td>
          ...
          <tr>
            ...
            <td valign="top"><a href="active_video.php" class="Lightblue">Active Video</a></td>
