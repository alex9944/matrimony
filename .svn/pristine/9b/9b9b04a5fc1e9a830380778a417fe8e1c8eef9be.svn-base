...
$result = mysql_query("SELECT MatriID,ConfirmEmail,Name,Gender,Regdate,Status, registered_on FROM register where Status = 'InActive' order by ID desc "); 
              ...
              <table width="54%" border="0" align="center" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  ...
                  <td><div align="center" class="headertext">
					 ...
					 <img src=images/icon7.gif width=19 height=16 />  Inactive Members
