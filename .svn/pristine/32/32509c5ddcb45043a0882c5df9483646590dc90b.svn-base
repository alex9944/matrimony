                    ...
                    <tbody>
                      <tr>
                        ...
                        style="FONT-SIZE: 11px; COLOR: #1670ae; FONT-FAMILY: verdana"><b>
                          ...
                          &nbsp;days </b></font></div></td>
                        <td width="142" valign="center"><div align="left"><span class="Partext1">MYR. <?php  echo $row['planamount']?>
                        </span></div></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="normaltxt1" valign="center"><p><strong>INDIA</strong><br />
                          ...
                          <p>Bank Name&nbsp;:&nbsp;Indian Overseas Bank&nbsp;<br />
                            Branch&nbsp;:&nbsp;Komarapalayam<br />
                            Bank Code&nbsp;:&nbsp;1350<br />
                            Account&nbsp;No&nbsp;:&nbsp;7639<br />
                            Name&nbsp;:&nbsp;M.Gunasekaran&nbsp;</p>
                          <p>or </p>
                          <p>Bank Name&nbsp;:&nbsp;Karur Vysya Bank&nbsp;<br />
Branch&nbsp;:&nbsp;Komarapalayam<br />
Account&nbsp;No&nbsp;:&nbsp;114715546870<br />
Name&nbsp;:&nbsp;M.Gunasekaran&nbsp;</p>
                          <p>or </p>
                          <p>Send Demand Draft in favour of ' Sri laxminarayna matrimonial .com' </p>
                          <p>or </p>
                          <p>Money Order to the following address.</p>
                          <p>M.Gunasekaran<br />
                            Srilaxminarayna Matrimonial.com<br />
                            102-8/70.A,Pallipalayam Road,<br />
                            Near K.O.N.Bus Stop,<br />
                            Komarapalayam -638 183<br />
                            Namakkal DT (Taminadu)<br />
                            Mobile : +91 - 9360410887&nbsp;<br />
                            <a href="#"></a></p></td>
                      </tr>
                      <tr>
                        <td 
