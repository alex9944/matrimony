...
$sql = mysql_query("SELECT * FROM register WHERE (Photo4 != '0' and Photo4 != '') and (Photo4Approve='No' or Photo4Approve='0' ) LIMIT $from, $max_results "); 
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="inner">
      ...
      <tr>
		...
		<form action="approve_photo4_submit_bulk.php" method="post" name="form1" id="form1" onSubmit="return approvevalidate()">
          ...
          <tr>
            ...
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">APPROVE MEMBERS PHOTO 4 <span class="paratext">(Waiting for Approval)</span> </td>
              ...
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><div align="center" class="smalltextgrey">
                    ...
                    <div align="left" class="smalltextred"> Below is the list of all Members Photo4 waiting approval .You can click on the profile ID to view the Photo.You can   approve/disapprove  by clicking the link. </div>
...
$total_results = mysql_result(mysql_query("SELECT COUNT(*) as Num FROM register WHERE (Photo4 != '0' and Photo4!='') and (Photo4Approve='No' or Photo4Approve='0' )"),0); 
...
?>
              ...
              <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0">
                ...
                <tr>
				 ...
				 $sql = "SELECT * FROM register WHERE Photo4 <> 'nophoto.gif' and Photo4Approve='No' order by ID desc LIMIT $from, $max_results";
                ...
                <TR bgcolor="#FFFFFF" onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';">
                  ...
                  <td class="smalltextgrey"><?php echo $row['Photo4Approve']?></td>
				...
				<?php /*?>  <img src="../photoprocess.php?image=memPhoto4/<?php echo $row['Photo4']?>&maxim_size=100" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewPhoto4.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">	<?php */?>

				  <?php // echo $row['Photo4']?>

				   <img src="../memphoto4/<?php echo $row['Photo4']?>" width="65"  hspace="1" vspace="1" border="0" class="submenubox" onClick="MM_openBrWindow('viewphoto4.php?id=<?php  echo $row['MatriID']?>&Choice=1','vp','resizable=yes,width=600,height=450')">		
                  ...
                  <td class="smalltextgrey"><a href="Approve_Photo4_submit.php?ID=<?php echo $row['MatriID']?>&amp;Action=approve">Approve Photo </a></td>

                  <td class="smalltextgrey"><a href="UnApprove_Photo4_submit.php?ID=<?php echo $row['MatriID']?>&amp;delphoto=<?php echo $row['Photo4']?>&amp;Action=unapprove&email=<?php echo $row['ConfirmEmail']?>&name=<?php echo $row['Name']?>">Disapprove Photo </a></td>
