...
<table width="98%" border="0" cellpadding="3" cellspacing="1" align="center">
  ...
  <tr>
    <td ><form action="manageclassifiedsearch.php" method="post"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	  <td width="7%" align="center"><span class="company_directory">Search</span>:</td>
        <td width="7%" align="left"><select name="select">
	 ...
	 echo $user_list=$user_fetch['reg_name'];
	  ?>
        ...
        <!--<td width="9%" align="center"><select name="select2">
		<option value="">Select</option>
          <?php 
	...
	// echo $user_list1=$user_fetch1['member'];
	  ?>
        ...
        <td width="10%" align="left"><input type="submit" name="Submit" value="Submit" /></td>
		<td width="20%" align="center" class="ad_text_color"><a href="individual_usertype.php?userview=All" class="link1">All</a></td>
        <!--<td width="29%" align="center" class="ad_text_color"><a href="individual_usertype.php?userview=2" class="link1" >Payment</a></td>-->
        <!--<td width="38%" align="center" class="ad_text_color"><a href="individual_usertype.php?userview=1" class="link1" >Free</a></td>-->
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="bottom"><!--<input name="delete" type="image"  src="../images/delete_x.jpg"class="button" value="Delete" onclick="if( confirm('Are you sure you want to Delete this Record?') )
						...
						{	
						return false; 
						}" />--><input name="delete" type="image"  src="../images/delete_x.jpg"class="button" value="Delete"  title="Delete"onclick="alert('This Feature Is Disabled In The Demo Version...');
return false;" /></td>
        </tr>
      </table>
    </form></td>
    ...
    <td bgcolor="#faf3f7"><?PHP
        ...
        <!--<a href="manageclassified.php?actid=<?PHP echo $userid_admin;?>" class="register" onclick="if(confirm('Are you sure you want to InActivate this Record?') )
							...
							<a href="manageclassified.php?actid=<?PHP echo $userid_admin;?>" class="ad_text_color" style="text-decoration:none; "	 onclick="return editfun()">Activate</a>
        <?php } ?></td>
  </tr>
  <?php } } else {?>
  ...
  <?php 
  $usertype=$_REQUEST['userview'];
  $member_select=mysql_query("select * from `membership` where `id`='$usertype'");
    ...
    <td bgcolor="#faf3f7"><form id="form1" name="delete" method="post" action="manageclassified.php?delid=<?php echo $reg_fetch['p_id'];?>">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
         ...
         <!-- <td align="center" valign="bottom"><input name="delete" type="image"  title="Delete" src="../images/delete_x.jpg"class="button" value="Delete" onclick="if( confirm('Are you sure you want to Delete this Record?') )
						{
						...
						<td align="center" valign="bottom"><input name="delete" type="image"  title="Delete" src="../images/delete_x.jpg"class="button" value="Delete" onclick="return editfun()"/>
        </tr>
      </table>
    </form></td>
    <td align="center" bgcolor="#faf3f7" class="ad_text_color"><a href="viewclassified.php?viewid=<?php echo $reg_fetch['p_id'];?>">View</a></td>
