...
$result = mysql_query("SELECT MatriID,ConfirmEmail,Name,Gender,Regdate,Status, registered_on FROM register where Status = 'Active' order by ID desc "); 
...
<title>Active Member Reports</title>
              ...
              <table width="54%" border="0" align="center" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  ...
                  <td><div align="center" class="headertext">
					 ...
					 <img src=images/icon8.gif width=19 height=16 />  Active Members
			   ...
			   <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				<thead>
					...
					<tr>
					  ...
					  <th ><strong>Reg On</strong></th>

					  <th ><strong>Status</strong></th>

					  <th ><strong>Full View </strong></th>
				...
				<tbody>	    <?php  $i = 1;      
					...
					<tr >
					  ...
					  <td ><a href="viewprofile.php?ID=<?php echo $row['MatriID']?>">View</a></td>
