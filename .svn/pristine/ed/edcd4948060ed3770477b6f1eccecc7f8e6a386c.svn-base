...
<div class="profile_block">
  ...
  <div class="body" align="left">
    <form action="videoprotect_submit.php" method="post" name="form" id="form"  onSubmit="return validate()">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_profiledetails">
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="content">
              <tr>
                <td align="left">If the video is protected, then other members can not visible your video. If anyone interested to view your video, then they will send a request video password to you. <br>
                  <br>
