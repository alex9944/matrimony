...
set_time_limit(0);
 ...
 $sel="select * from register where Gender='Female' "; 
		...
		if($from_age == '')
		 {
		   ...
		   $qr="select * from register where Gender='Male' and Looking='".$looking."' and Caste='".$caste."' and Religion='".$religion."'  order by ID desc limit 0,20";   
