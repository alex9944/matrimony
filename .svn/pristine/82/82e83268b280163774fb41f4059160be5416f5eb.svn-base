...
$update1 = mysql_query("UPDATE adminlogin SET adminpassword ='$strcp' WHERE id='1' ")
...
or die("Could not update data because ".mysql_error());
     ...
     print " self.location='setadminpassword.php?action=wrong old password';"; // Comment this line if you don't want to redirect
