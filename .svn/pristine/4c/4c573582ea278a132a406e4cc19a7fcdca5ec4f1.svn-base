...
<center>
  ...
  &nbsp;This email was sent to you because you have  agreed to receive emails from us. If you wish to stop receiving them send an  email with any subject and text to <a href="mailto:'.$sitadmin.' ">unsubscribe</a> </p>
														   <p>&nbsp;</p>
														   <br>
                                                          </div>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="350">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2013 '.$sitename.' , All rights reserved.</em>
																<br />
