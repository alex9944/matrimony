...
$religion_array = array("1"=>"Hindu","2"=>"Muslim - Shia","3"=>"Muslim - Sunni","4"=>"Muslim - Others","5"=>"Christian - Catholic","6"=>"Christian - Orthodox","7"=>"Christian - Protestant","8"=>"Christian - Others","9"=>"Sikh","10"=>"Jain - Digambar","11"=>"Jain - Shwetambar","12"=>"Jain - Others","13"=>"Parsi","14"=>"Buddhist","15"=>"Inter-Religion","16"=>"No Religious Belief");
...

{
	...
	window.location.href = 'advsearch_results.php?page='+pageno+linktext;
...
$strgender = $_REQUEST['gender'];

$strms = $_REQUEST['ms'];

$strage1 = $_REQUEST['age1'];

$strage2 = $_REQUEST['age2'];

$strh1 = $_REQUEST['height1'];

$strh2 = $_REQUEST['height2'];

$strrel = $_REQUEST['religion'];

$strcaste = $_REQUEST['caste'];

$strlan = $_REQUEST['language'];

//$stredu = $_REQUEST['edu'];

//$stroccu = $_REQUEST['occu'];

$strcoun = $_REQUEST['country'];

$strphoto = $_REQUEST['photo'];
...
//echo " G :".$strgender." Ms:".$strms." A1:".$strage1." A2:".$strage2." H1:".$strh1." H2:".$strh2." R:".$strrel." C:".$strcaste." L:".$strlan." E:".$stredu." OCC:".$stroccu." Cou:".$strcoun." P:".$strphoto;

//education set

$educationset = "";

foreach($_REQUEST['eduset'] as $key => $eduvalue)
...
if(isset($_REQUEST["educationset"]))
...
foreach($_REQUEST['occuset'] as $key => $occuvalue)
...
if(isset($_REQUEST["occupationset"]))
...
foreach($_REQUEST['appearanceset'] as $key => $appearancevalue)
...

{
	...
	$searchquery .= " AND Maritalstatus = '".$strms."'";

	$searchcondition .= ", Matrialstatus :".$strms;
...

{
	...
	//$searchquery .= " AND Religion = '".$strrel."'";
    $searchquery .= " AND (Religion = '".$strrel."' || Religion like '%".$religion[$strrel]."%') ";
	$searchcondition .= ", Religion:".$religion_array[$strrel];

}


//echo "<pre>"; print_r($caste_array);

if($strcaste != "Any" and $strcaste != '')
...

{
	...
	$searchquery .= " AND Height < '".$strh2."'";

	$searchcondition .= ", Height :".$strh1." - ".$strh2;
...

{
	...
	$searchquery .= " AND Language = '".$strlan."'";

	$searchcondition .= ", Language :".$strlan;
...

{
	...
	$searchquery .= " AND Education = '".$stredu."'";

	$searchcondition .= ", Education :".$stredu;
...

{
	...
	$searchquery .= " AND Occupation = '".$stroccu."'";

	$searchcondition .= ", Occupation :".$stroccu;
...

{
    ...
    $strcoun = $_REQUEST['country'];
	//echo 'country';
	$searchquery .= " AND Country = '".$strcoun."'";

	$searchcondition .= ", Country :".$strcoun;
...

{
	...
	$searchquery .= " AND Age BETWEEN '".$strage1."' AND '".$strage2."'";

	$searchcondition .= ", Age :".$strage1." Yrs to".$strage2." Yrs";
...
<form action="" method="post" name="searchrsforms" id="searchrsforms">
 ...
 <a name="top" id="top"></a>
    ...
    <strong> You have searched for:</strong> <?php echo $strgender; ?>, <?php echo $searchcondition;?>. 
...
$link = "&gender=".$_REQUEST['gender']."&ms=".$_REQUEST['ms']."&age1=".$_REQUEST['age1']."&age2=".$_REQUEST['age2']."&height1=".$_REQUEST['height1']."&height2=".$_REQUEST['height2']."&religion=".$_REQUEST['religion']."&caste=".$_REQUEST['caste']."&language=".$_REQUEST['language']."&edu=".$_REQUEST['edu']."&occu=".$_REQUEST['occu']."&country=".$_REQUEST['country']."&State=".$State."&City=".$City."&Weight=".$Weight."&educationset=".$educationset."&occupationset=".$occupationset."&photo=".$_REQUEST['photo'];
...
<a href="viewfullprofile1.php?id=<?php echo $searchresultfetch['MatriID']; ?>" class="icon_acc_type" title=" <?php echo $plan; ?> Account Holder"> <?php echo $plan; ?></a>
