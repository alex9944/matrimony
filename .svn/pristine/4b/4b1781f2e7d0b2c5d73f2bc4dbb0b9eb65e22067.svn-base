...
<div id="container">
	...
	<div class="con_rgt">
		...
		<div class="in_head">
			<div class="in_head">
				<div class="in_head">
					<div class="head_txt">Post Classified</font></div>
				</div>
			</div>
		</div>
		...
		<div class="frmcont">
			<form action="" method="post" enctype="multipart/form-data" name="postForm" id="form1" onsubmit="return postCheck();">
					  ...
					  if(mysql_num_rows($usersql) > 0)
					  {
					   ?> 
									  ...
									  <tr>
                                        ...
                                        <td align="center" class="bold">:</td>
                                        <td><input name="pricess" type="text" maxlength="12" value="<?php echo $_POST['title'];?>" id="pricess" class="text_box" onblur="space(this.id)" style="width:100px;" /> <em>If you are giving away your item, enter a price of 0 </em></td>
                                      </tr>
									  <tr>
		                  ...
		                  while($con2=mysql_fetch_array($sta2)) {?>
									  ...
									  <tr>
                                        ...
                                        <td align="center" class="bold">:</td>
                                        <td>
											<input type="Radio" name="iam" checked="checked" value="1" />&nbsp;&nbsp;An Individual&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="Radio" name="iam" value="2" />&nbsp;&nbsp;A Professional/Business
										</td>
                                      </tr>
                                      <!--<tr>
                    ...
                    <td height="25" colspan="4" align="left" ><input id="godate1"  name="godate1" type="text" size="15" readonly="true" onclick="javascript:NewCal('godate1','ddmmyyyy')">&nbsp;<a href="javascript:NewCal('godate1','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date" style="vertical-align:bottom;"></a></td>
                                      ...
                                      <tr>	
                                        <td colspan="3">
										  <div id="ph1" style="display:block;">
					...
					?>
									  ...
									  <tr>
                                        ...
                                        <td align="center" class="bold">:</td>
                                        <td>
										  <label class="bold"><?php echo $postname;?></label>
										  <input type="hidden" name="conname" readonly="true"  value="<?php echo $postname;?>"/> 
										</td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td align="center" class="bold">:</td>
                                        <td>
										   <label class="bold"><?php echo $postemail;?></label>
										   <input type="hidden" name="conemail" readonly="true" value="<?php echo $postemail;?>"/> </td>
                                      </tr>
                                      <tr>
                                        <td class="bold">Contact Number</td>
                                        <td align="center" class="bold">:</td>
                                        <td>
										   <label class="bold"><?php echo $postphone;?></label>
										   <input type="hidden" name="conphone" readonly="true" value="<?php echo $postphone;?>"/> 
										   </td>
                                      </tr>
                                      <tr>
                                        <td height="80" colspan="3" align="center">
											<input name="Submit" type="submit" class="but_bg" value="Submit" />&nbsp;&nbsp;&nbsp;
