...
$sql = mysql_query("SELECT * FROM payment_details order by id desc LIMIT $from, $max_results"); 
...
?>
              ...
              <table width="98%" border="1" align="center" cellpadding="4" cellspacing="0" class="blackbox">
                ...
                <tr>
				  ...
				  <td width="7%" align="center" bgcolor="#ECECEC" class="paratext">Payment Mode</td>
                  ...
                  <td width="9%" bgcolor="#ECECEC" class="paratext">Options</td>
                </tr>

				 <?php $slno = 0; while($row = mysql_fetch_array($sql)){ ?>
                ...
                <TR bgcolor="#FFF5EB" onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';" height="73px">
				  ...
				  echo "Astromatch 1 Year - 1"."<br>";
				  } elseif($row['astro_3months'] == 1) {
				  echo "Astromatch 3 months - 1"."<br>";
				  }elseif($row['astro_6month'] == 1) {
				  echo "Astromatch 6 months - 1"."<br>";
				  }
				  ...
				  <td class="smalltextgrey"><?php echo $row['payment_type']?></td>
                  ...
                  <td class="smalltextgrey"><a href="javascript:;" onclick="javascript: deleteConfirm('payment_details.php?key=delete&id=<?php echo $row['id']; ?>');"><img src="images/icon7.gif" alt="InActive Profile" width="19" height="16" /></td>
                </tr>
