...
?>
                              ...
                              <table width="130" border="0" cellpadding="0" cellspacing="0" class="tbl_profiledetails" >
                                ...
                                <tr>
                                  <td><div align="center"><img src="photoprocess.php?image=memphoto2/<?php echo $row['Photo2']?>&maxim_size=100;" /></div></td>
                                </tr>
                                <tr>
                                  <td><div align="center"> <a href="modifyphoto.php?Choice=2&op=<?php echo $row['Photo2']; ?>">Modify Photo 2 </a> </div>
                                    ...
                                    <br>
                                    <div align="center">
                                    <a href="deletephoto.php?Choice=2&op=<?php  echo $row['Photo2'] ?>">Delete Photo 2 </a> <br></td>
                                </tr>
                              </table>
                              <?php
...
?>
                              <table width="130" border="0" cellpadding="0" cellspacing="0" class="tbl_profiledetails" id="PHMainPhoto" >
                                ...
                                <tr>
                                  <td><div align="center"><img src="photoprocess.php?image=memphoto3/<?php echo $row['Photo3']?>&maxim_size=100;" /></div></td>
                                </tr>
                                <tr>
                                  <td><div align="center"> <a href="modifyphoto.php?Choice=3&op=<?php echo $row['Photo3']; ?>">Modify Photo 3 </a> </div>
                                    ...
                                    <br>
                                    <div align="center">
                                    <a href="deletephoto.php?Choice=3&op=<?php  echo $row['Photo3'] ?>">Delete Photo 3 </a> <br></td>
                                </tr>
                              </table>
                              <?php
...
?>
                              ...
                              <table width="130" border="0" cellpadding="0" cellspacing="0" class="tbl_profiledetails" >
                                ...
                                <tr>
                                  <td><div align="center"><img src="photoprocess.php?image=memphoto5/<?php echo $row['Photo5']?>&maxim_size=100;" /></div></td>
                                </tr>
                                <tr>
                                  <td><div align="center"> <a href="modifyphoto.php?Choice=5&op=<?php echo $row['Photo5']; ?>">Modify Photo 5 </a> </div>
                                    ...
                                    <br>
                                    <div align="center">
                                    <a href="deletephoto.php?Choice=5&op=<?php  echo $row['Photo5'] ?>">Delete Photo 5 </a> <br></td>
                                </tr>
                              </table>
                              <?php
...
?>
                              <table width="130" border="0" cellpadding="0" cellspacing="0" class="tbl_profiledetails" id="PHMainPhoto" >
                                ...
                                <tr>
                                  <td><div align="center"><img src="photoprocess.php?image=memphoto6/<?php echo $row['Photo6']?>&maxim_size=100;" /></div></td>
                                </tr>
                                <tr>
                                  <td><div align="center"> <a href="modifyphoto.php?Choice=6&op=<?php echo $row['Photo6']; ?>">Modify Photo 6 </a> </div>
                                    ...
                                    <br>
                                    <div align="center">
                                    <a href="deletephoto.php?Choice=6&op=<?php  echo $row['Photo6'] ?>">Delete Photo 6 </a> <br></td>
                                </tr>
                              </table>
                              <?php
