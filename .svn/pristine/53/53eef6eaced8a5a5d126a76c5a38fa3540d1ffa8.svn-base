function caste_disable(obj){
	if ( document.searchform.religion.value == 'Others' ){
	document.searchform.caste.value = '';
	document.searchform.caste.disabled = true;
	}
	else {
		document.searchform.caste.disabled = false;
...

{
	...
	field_info = eval("document.searchform." + field_name);
