...
$upss = mysql_query("UPDATE class_register set reg_name='$ename',reg_address='$address',reg_phone='$ephone',reg_state='$state',reg_city='$city',reg_website='$website' WHERE reg_id ='$userid'") or die(mysql_error());
if($upss)
{
...
<div id="container">
	...
	<div class="con_rgt">
		...
		<form name="indexform" method="post" action="#" onsubmit="return regCheck();">
			...
			<option value="<?php echo $con2['countryid'];?>" <?php if($editcountry==$con2['countryid']) {echo "selected";} ?> ><?php echo $con2['country'];?></option>
			<?php } ?>
			</select>						
			</td>
			</tr>-->			
		...
		<?php /* <tr>
			...
			<tr>
                    ...
                    <td>
					    <div id="statenew">
							...
							<option value="<?php echo $stat['stateid'];?>" <?php if($stat['stateid'] == $editstate) echo "selected"; ?> ><?php echo $stat['state_name'];?></option>
							<?php } ?>
							</select>
						</div>
					 <!--<input name="state" id="state" class="text_box" type="text" value="<?php //echo $editstate; ?>" /> -->
            ...
            <tr>
              <td colspan="3" align="center">
			  	<input type="submit" name="editbutton" id="editbutton" value="Update Profile" class="but_bg" <?php if(isset($_SESSION['dlogin'])) { ?> disabled="disabled" <?php } ?>/>&nbsp;&nbsp;&nbsp;&nbsp;
