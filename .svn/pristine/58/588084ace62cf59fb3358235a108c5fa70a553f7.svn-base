...
$astromatch_count  = $_POST['astromatch_count'];

$update1 = mysql_query("update membershipplan set plandisplayname ='$str_pdn',plannoofcontacts='$str_noc',planduration='$str_pd',planamount='$str_pa', astromatch_count = '$astromatch_count', sms_count = '$sms_count' WHERE planid= '$strpid' ");
