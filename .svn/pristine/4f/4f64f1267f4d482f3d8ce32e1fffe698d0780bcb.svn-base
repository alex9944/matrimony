...
$sql = mysql_query("SELECT * FROM register where Status <> 'InActive' and Status <> 'Active' order by ID desc"); 
...
<title>Remove paid Members</title>
</head>
          ...
          <tr>
            <td height="54" colspan="4" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="97%" class="headertext">Remove Paid Members </td>
              </tr>
            </table>
              <br />
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><div align="center" class="smalltextgrey">
                    <div align="left" class="smalltextred"> Below is the list of all Paid Members.&nbsp; You can click on the  ID to view the register details. and you can clicking Delete link to Permanently remove the members from database. </div>
                  </div></td>
                </tr>
              </table>
              <br />
