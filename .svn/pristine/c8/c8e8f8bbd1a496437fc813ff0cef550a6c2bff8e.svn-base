            ...
            <td colspan="4" valign="top" class="HeadText1"><p>&nbsp;</p>
              ...
              <table width="68%" height="85" border="0" align="center" cellpadding="2" cellspacing="0" class="blackbox" id="content">
                ...
                <tr>
                  ...
                  <td colspan="4" bgcolor="#FBFBFB" class="H1Text"><div align="center" class="error">Dynamic Pages</div></td>

                  </tr>
                  <tr>
                  <td colspan="5" valign="top"><a href="admin-add-category.php" class="Lightblue">Add Category</a></td>
                  </tr>
                  <tr>
                  <td colspan="5" valign="top"><a href="admin-edit-category.php" class="Lightblue">Edit Category</a></td>
                  </tr>
                  <tr>
                  <td colspan="5" valign="top"><a href="admin-add-pages.php" class="Lightblue">Add pages</a></td>
                  </tr>
                  <tr>
                  <td colspan="5" valign="top"><a href="admin-edit-page.php" class="Lightblue">Edit pages</a></td>
                  </tr>
