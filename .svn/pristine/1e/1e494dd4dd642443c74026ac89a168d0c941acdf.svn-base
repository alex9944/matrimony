...
<div id="wrapper"> 
  ...
  "ZW" => "Zimbabwe"
              ...
              <tr class="hline2">
				...
				<?php $caste =array('-Select-','Hindu', 'Muslim - Others', 'Christian - Others', 'Sikh','Jain - Others','Parsi','Buddhist','Inter-Religion','No Religious Belief','Muslim - Shia','Muslim - Sunni','Christian - Catholic','Christian - Orthodox','Christian - Protestant','Jain - Digambar','Jain - Shwetambar');
			 ?>
				<select name="religion" id="religion" onChange="return caste_disable(document.MatriForm.religion);" style="width:200px;" onchange="caste()">
                    ...
                    <option value="<? echo $i; ?>" selected><? echo $caste[$i]; ?></option>
						<?php } else { ?>
                      <option value="<? echo $caste[$i] ?>" ><? echo $caste[$i] ?></option>
					  <?php }  }?> 
                  </select>
				 </div></td>
