...
<body>
	...
	<p style='font:normal 12px Arial, MS Sans serif, tahoma;color:#000000;'>Congratulations! Your profile on <?php echo $sitename; ?> has been validated and activated. You are now ready to search and contact millions of validated profiles for FREE.<br />
	<br />
	Log on to <a href='" & StrSite_Config_DURL & "' target='_blank' rel='nofollow'><?php echo $sitename; ?></a> now using the follwing information to find your dream partner.</p>
	...
	<p style='font:normal 12px Arial, MS Sans serif, tahoma;color:#000000;'>Everybody here at <?php echo $sitename; ?>, wish you all the very best in your search for a life partner. Should you require any further assistance, do not hesitate to callour officeOR visit our 24/7 live support. OR send mail us to <a href='mailto:<?php echo $siteadmin; ?>" & StrSite_Config_Email_From & "'><?php echo $siteadmin; ?></a> </p>
	...
	<?php echo $sitename; ?></p>
	<p style='font:normal 10px Arial, MS Sans serif, tahoma;color:#000000;'>You are receiving this mail as a registered member of <?php echo $sitename; ?> " & StrSite_Config_FURL & ". Please add <a href='mailto:" & StrSite_Config_Email_From & "' target='_blank' rel='nofollow'>" & StrSite_Config_Email_From & "</a> to your address book to ensure delivery into your inbox. </p></td>
	<td width="8">&nbsp;</td>
	</tr>
	<tr>
