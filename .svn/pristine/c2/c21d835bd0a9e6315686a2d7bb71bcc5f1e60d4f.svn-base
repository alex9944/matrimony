...
/*BEGIN TABS*/
	...
	table#mediaTypeOne td#mainContent div#main{margin:10px 0 30px 30px;z-index:1; height:50px; position:relative; top:20px;}
...
@media screen {
/* Header */
	div#header {width:764px; margin:0 auto;}
...
<p id="readMore"><b><font color="#9E0C4D" size="3">Send SMS message to member  </font> </b> Here you can send SMS to our members. Please specify the username of the person you are sending and the text of the message.<br />
</p>
<div id="blockQuestion">
 ...
 <tr>
    <td width="16%"  nowrap="nowrap"><p >Nick Name: </p></td>
    <td width="84%" valign="top">
        <div id="ima" style="padding:0 390px 10px 27px">
          <input type="text" name="nick_name" id="nick_name" value="" size="63" height="20" >
        </div></td>
  </tr>
  <tr>
    ...
    <td>
        <div align="left" style="padding:0 0 10px 27px">
          <textarea name="message" rows="20" id="body" style="width:488px " lang="160"></textarea>
        </div></td>
  </tr>
  ...
  <tr>
    ...
    <td>
		<!-- <div style="float:left "> -->
		 &nbsp;&nbsp;&nbsp; <input class="button-small square-orange uppercase float_right" style="float:none; clear:both; border:0px;" name="submit" type="image" value="submit" alt="Send SMS" onClick="return do_submit()">	</td>
  </tr>
</tbody></table>		  </td>
        </tr>		
	</table>
