	function validate()
  {
  		 if ( document.MatriForm.age1.value == "" )
		 {
			alert( "Please enter minimum age." );
			document.MatriForm.age1.focus( );
			return false;
		}
		 if ( document.MatriForm.age1.value < 18 )
		 {
			alert( "Minimum age should be above 18" );
			document.MatriForm.age1.focus( );
			return false;
		}
		if ( document.MatriForm.age1.value > 60 )
		 {
			alert( "Minimum age should not be above 60" );
			document.MatriForm.age1.focus( );
			return false;
		}
		 if ( document.MatriForm.age2.value == "" )
		 {
			alert( "Please enter maximum Age" );
			document.MatriForm.age2.focus( );
			return false;
		}
		if ( document.MatriForm.age2.value > 60 )
		 {
			alert( "Maximum Age should be below 60" );
			document.MatriForm.age2.focus( );
			return false;
		}
		if ( document.MatriForm.age2.value < 18 )
		 {
		...
		/*if ( document.MatriForm.religion.selectedIndex == 0 )
		{
			...
			document.MatriForm.religion.focus( );
			return false;
		}*/
		if ( document.MatriForm.location.value == "")
		{
			alert( "Please enter the location." );	
			document.MatriForm.location.focus( );
			return false;
		}
}
