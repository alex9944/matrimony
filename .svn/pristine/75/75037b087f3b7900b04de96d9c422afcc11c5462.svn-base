...
$strid=$_GET['id']; 
$sql  = "SELECT v.*, r.*, Left(r.profile,200) as profile1 FROM verify_profile v ,register r where v.matriid = r.MatriID and r.Matriid='$strid' ";
...
<table width="600" height="450" border="0" cellpadding="0" cellspacing="0" class="Thickorangeborder">
  <tr>
    <td valign="top"><table width="100%" height="22" border="0" cellpadding="0" cellspacing="0">
      ...
      <?php 
	   //$verify_profile = mysql_query("SELECT r.*,v.* FROM verify_profile v ,register r WHERE v.matriid = r.MatriID LIMIT 0, 10");
	   while($row = mysql_fetch_array($result)){ //echo '<pre>'; print_r($row); exit; ?>
        <table width="590" border="0" align="center" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <?php  echo $row['MatriID']?>
              ...
              <div align="center">
              <div align="center"> <img src="../verify_profile/<?php  echo $row['img']?>" 
