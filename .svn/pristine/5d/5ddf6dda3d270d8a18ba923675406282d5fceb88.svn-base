<?  
/*  
http://www.phpscriptexpert.com/script.php?pn=Image%20Resize%20and%20Watermark&pid=198  
*/  
...
$font = "verdana.ttf"; //this font(georgia.ttf) heave to be in the same directory as this script  
$font_size = 11;  
$angle = 90;  
